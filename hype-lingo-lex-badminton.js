...
window.HYPE_LINGO_LEX.badminton = {
  ...
  { ref:"concours-complet", lecon:2, coll:"complet",
    ...
    def:{ fr:"Trois tests, un cheval, un cavalier : dressage, cross, obstacle. ⚠️ Aucun mot commun entre les langues. L'anglais dit **eventing**, l'allemand « la polyvalence », le japonais « l'art équestre complet ». Traduire « complete competition » ne sera pas compris.",
          ...
          ar:"ثلاثة اختبارات، وحصان واحد، وفارس واحد: الترويض، واختراق الضاحية، وقفز الحواجز. ⚠️ لا يوجد مصطلح مشترك بين جميع اللغات. ففي الإنجليزية تسمى الرياضة **eventing**، بينما تعكس بعض اللغات الأخرى فكرة تعدد المهارات أو اكتمالها. والترجمة الحرفية لعبارة «complete competition» لن تكون مفهومة." } },
  ...
  { ref:"cross", lecon:2, coll:"complet",
    ...
    def:{ fr:"Le test de fond, sur obstacles fixes en terrain naturel. ⚠️ L'allemand est le seul à ne rien emprunter : **das Gelände**, « le terrain ». Et les Britanniques abrègent tout en **XC**, y compris à l'écrit sur les horaires.",
          ...
          ar:"اختبار القدرة والمهارة فوق حواجز ثابتة في أرض طبيعية. ⚠️ وفي الألمانية يستخدم مصطلح **das Gelände**، أي «الميدان الطبيعي»، بينما يختصر البريطانيون cross-country إلى **XC** حتى في الجداول المكتوبة." } },
  ...
  { ref:"trot-presentation", lecon:2, coll:"complet",
    ...
    def:{ fr:"Le cheval présenté en main devant un jury vétérinaire, tressé et lustré, qui vérifie qu'il est apte à concourir. On le fait avant le concours et, en complet international, encore le matin de l'obstacle.",
          ...
          ar:"يقدم الحصان باليد أمام لجنة بيطرية، بعرف مضفور وشعر لامع، للتأكد من لياقته للمنافسة. يجرى الفحص قبل المسابقة، وفي البطولات الدولية للفروسية الثلاثية يجرى مرة أخرى قبل اختبار قفز الحواجز بحسب صيغة المسابقة." } },
  ...
  { ref:"obstacle-fixe", lecon:2, coll:"complet",
    ...
    def:{ fr:"Il ne tombe pas. C'est toute la différence avec l'obstacle de concours hippique, et c'est la raison pour laquelle le gilet de protection et le casque aux normes sont obligatoires au cross, partout.",
          ...
          ar:"حاجز لا يسقط عند لمسه، خلافا لحواجز قفز الحواجز القابلة للسقوط. ولهذا تفرض لوائح اختراق الضاحية خوذة وسترة حماية مطابقتين للمواصفات المعمول بها." } },
  ...
  { ref:"option", lecon:2, coll:"complet",
    mots:{ fr:{m:"l'option"}, en:{m:"the long route", p:"long route", var:"the alternative"},
           ...
           de:{m:"der Umweg", p:"oum-vék", var:"der Alternativweg"}, ja:{m:"迂回ルート", p:"ukai rūto"},
           ar:{m:"المسار البديل"} }, /* de precise (rapport 07/08) */
    def:{ fr:"Le chemin plus long et plus sûr, autorisé sur les combinaisons de cross. Prendre l'option directement coûte des secondes, pas de pénalité particulière — mais un refus au préalable reste pénalisé, et un cavalier expérimenté la choisit sans hésiter quand son cheval doute.",
          en:"The longer, safer way through a cross-country combination. Taken directly, it costs seconds and no particular penalty — though a refusal beforehand is still penalised.",
          es:"El camino más largo y más seguro, autorizado en las combinaciones de cross. Tomar la opción directamente cuesta segundos, sin penalización específica — pero un rehúse previo sí se penaliza, y un jinete experimentado la elige sin dudar cuando su caballo duda.",
          it:"La strada più lunga e più sicura, autorizzata sulle combinazioni di cross. Prendere l'opzione direttamente costa secondi, senza penalità specifica — ma un rifiuto precedente resta penalizzato, e un cavaliere esperto la sceglie senza esitare quando il suo cavallo dubita.",
          de:"Der längere, sicherere Weg, an Geländekombinationen erlaubt. Direkt gewählt kostet die Option Sekunden, keine eigenen Strafpunkte — eine vorherige Verweigerung wird aber bestraft, und ein erfahrener Reiter wählt sie ohne Zögern, wenn sein Pferd zweifelt.",
          ja:"クロスの連続障害で認められている、遠回りで安全な経路。最初からこちらを選べば失うのは秒数だけで、選択そのものへの減点はありません。ただし直前の拒止の減点は残ります — そして経験ある騎手は、馬が迷った瞬間、ためらわずこちらを選びます。",
          ar:"مسار بديل يكون غالبا أطول وأسهل، ويكون مسموحا به عند بعض الحواجز المركبة في اختراق الضاحية. وإذا اختارته الفارسة مباشرة ونفذته بصورة صحيحة، فإنه يكلفها وقتا إضافيا من دون جزاء خاص لمجرد اختياره. أما الانتقال إليه بعد رفض أو خطأ فيخضع للعقوبات المقررة." } },
  ...
  { ref:"temps-optimum", lecon:2, coll:"complet",
    mots:{ fr:{m:"le temps optimum"}, en:{m:"the optimum time", p:"op-ti-meum taïm"},
           ...
           ar:{m:"الزمن المستهدف"} }, // ??
    def:{ fr:"Le temps de référence du cross, calculé sur la distance et la vitesse imposée. Au-delà, on prend des pénalités de temps selon le barème en vigueur. Ce n'est donc pas une course : c'est un exercice de régularité, chronomètre au poignet.",
          en:"The reference time for cross-country, from distance and required speed. Beyond it, time penalties accrue according to the scoring in force — so it is regularity, not racing.",
          es:"El tiempo de referencia del cross, calculado sobre distancia y velocidad impuesta. Más allá, se toman penalizaciones de tiempo según el baremo vigente. No es pues una carrera: es un ejercicio de regularidad, cronómetro en la muñeca.",
          it:"Il tempo di riferimento del cross, calcolato su distanza e velocità imposta. Oltre, si prendono penalità di tempo secondo il regolamento in vigore. Non è dunque una corsa: è un esercizio di regolarità, cronometro al polso.",
          de:"Die Referenzzeit des Geländes, aus Distanz und vorgegebenem Tempo errechnet. Darüber gibt es Zeitstrafpunkte nach der geltenden Wertung. Kein Rennen also — eine Übung in Gleichmaß, mit der Uhr am Handgelenk.",
          ja:"距離と規定速度から計算される、クロスの基準タイム。超えれば、適用される方式に従ってタイム減点が加算されます。つまり競走ではなく、腕時計を頼りに刻む、一定さの試験なのです。",
          ar:"الزمن المرجعي لمسار اختراق الضاحية، ويحدد وفقا لطول المسار والسرعة المطلوبة. ويؤدي تجاوز هذا الزمن إلى إضافة جزاءات زمنية بحسب النظام المطبق. لذلك لا يتعلق الأمر بالسرعة القصوى، بل بالحفاظ على إيقاع مناسب وإدارة الزمن بدقة." } },
  ...
  { ref:"reprise-dressage", lecon:2, coll:"complet",
    ...
    def:{ fr:"La PREMIÈRE des trois épreuves du complet, et celle qui donne le score de départ. 🟥 Elle ne se note pas en points gagnés mais CONVERTIE EN PÉNALITÉS : mieux on la fait, moins on en a. C'est ce qui déroute tout le monde au début — au complet, on cherche le score le plus BAS. ⚠️ « La reprise » ici désigne l'ÉPREUVE ; à Windsor le même mot désigne le protocole, et à Aberystwyth le groupe d'élèves. Trois sens, un mot.",
          ...
          ar:"🟥 أول اختبارات الفروسية الثلاثية، ومنه تبدأ نتيجة الثنائي. تحول نتيجة الترويض إلى نقاط جزاء، فكلما كان الأداء أفضل قل مجموع الجزاءات. وفي الفروسية الثلاثية يفوز صاحب المجموع الأدنى." } },
  ...
  { ref:"parcours-obstacle", lecon:2, coll:"complet",
    mots:{ fr:{m:"le parcours d'obstacle"}, en:{m:"the showjumping round", p:"chô-djeum-pinng raound", var:"the showjumping"},
           ...
           ar:{m:"جولة قفز الحواجز"} },
    def:{ fr:"⚠️ À Badminton et dans les formats longs classiques, C'EST LA DERNIÈRE ÉPREUVE, et c'est voulu : elle se court après le cross, sur un cheval fatigué, et c'est là que les classements se retournent — d'autres formats ordonnent les épreuves autrement. ⚠️ En anglais on dit **showjumping** en un mot pour la discipline, jamais « obstacle » — et au complet on dit souvent simplement *the jumping*.",
          en:"At Badminton and in the classic long formats it is the last phase, and deliberately so: it's ridden after the cross-country, on a tired horse, and that's where placings turn over — other formats order the phases differently. « Showjumping » is one word; in eventing you often just say « the jumping ».",
          es:"En Badminton y en los formatos largos clásicos es la última prueba, y a propósito: se corre después del cross, con un caballo cansado. Ahí se dan la vuelta las clasificaciones — otros formatos ordenan las pruebas de otro modo.",
          it:"A Badminton e nei formati lunghi classici è l'ultima prova, e volutamente: si corre dopo il cross, su un cavallo stanco. È lì che le classifiche si ribaltano — altri formati ordinano le prove diversamente.",
          de:"In Badminton und den klassischen langen Formaten die letzte Teilprüfung, und das mit Absicht: sie kommt nach dem Geländeritt, auf einem müden Pferd. Dort drehen sich die Platzierungen — andere Formate ordnen die Prüfungen anders.",
          ja:"バドミントンや伝統的なロング形式では最後の競技。これは意図的で、クロスカントリーのあと、疲れた馬で走ります。ここで順位がひっくり返ります。形式によって競技の順序は異なります。",
          ar:"⚠️ في بادمينتون وفي الصيغ الطويلة التقليدية، يكون قفز الحواجز الاختبار الأخير بعد اختراق الضاحية. ويخوضه الحصان بعد الجهد الكبير الذي بذله في اليوم السابق، لذلك قد تغير جولة من دون أخطاء الترتيب كله. أما ترتيب الاختبارات في بعض الصيغ الأخرى فقد يختلف." } },
  ...
  { ref:"bareme", lecon:2, coll:"complet",
    ...
    def:{ fr:"🟥 LE MOT À SAVOIR POSER EN QUESTION, parce que la réponse change selon le niveau, le pays et l'année : « quel barème s'applique ? » est une question légitime même pour un cavalier expérimenté. ⚠️ Ce que le barème du complet a de particulier : les pénalités des trois épreuves S'ADDITIONNENT, et le total le plus bas gagne. Un sans-faute au cross ne fait pas gagner de points — il n'en fait pas perdre, ce qui n'est pas la même chose.",
          ...
          ar:"🟥 من المهم أن تعرفي كيف تسألين عن طريقة احتساب النقاط، لأن القواعد قد تختلف بحسب المستوى والبلد والموسم. والسؤال «ما طريقة احتساب النقاط المعمول بها؟» مشروع حتى لفارسة خبيرة. ⚠️ في الفروسية الثلاثية تضاف جزاءات الاختبارات الثلاثة بعضها إلى بعض، ويفوز أقل مجموع. والجولة من دون أخطاء في اختراق الضاحية لا تمنحك نقاطا إيجابية، بل تتجنب إضافة جزاءات إلى مجموعك." } },
  ...
  { ref:"classement-provisoire", lecon:2, coll:"complet",
    ...
    def:{ fr:"🟥 LA NOTION PROPRE AU COMPLET : on est classé alors que deux épreuves restent à courir. Être troisième après le dressage ne veut presque rien dire — le cross rebat tout. ⚠️ EN ANGLAIS ON NE DIT PAS « I am third » MAIS **I'm lying third** — « je suis couché troisième », une tournure qui surprend et qu'on entend partout sur un concours. *The interim standings* est le terme officiel, *the leaderboard* celui qu'on emploie.",
          ...
          ar:"يظهر ترتيب مؤقت بعد كل اختبار حتى قبل اكتمال المسابقة. وقد يتغير المركز بعد الترويض كثيرا خلال اختراق الضاحية. ⚠️ وفي الإنجليزية يقال غالبا **I'm lying third** للتعبير عن المركز المؤقت. أما المصطلح الرسمي فهو *interim standings*، ويستخدم *leaderboard* كثيرا في الحديث اليومي." } },
  ...
  { ref:"terrain-vallonne", lecon:2, coll:"complet",
    mots:{ fr:{m:"le terrain vallonné"}, en:{m:"hilly ground", p:"hi-li graound"},
           ...
           ar:{m:"التضاريس المتفاوتة"} },
    def:{ fr:"⚠️ CE QUI ÉPUISE UN CHEVAL SUR UN CROSS, autant que la hauteur des obstacles. Badminton et Burghley sont des parcs anglais tout en montées et descentes : on économise son cheval au début, on récupère du temps sur le plat. ⚠️ En anglais on dit **hilly ground**, et « the going » pour l'état du sol — deux notions différentes qu'un seul mot français recouvre.",
          en:"What tires a horse on a cross-country course, quite as much as the height of the fences. Badminton and Burghley are English parks all up and down: you save your horse early and make up time on the flat. Note « hilly ground » for the shape and « the going » for the state of the surface.",
          es:"Lo que agota a un caballo en un cross, tanto como la altura de los obstáculos. Se economiza el caballo al principio y se recupera tiempo en lo llano.",
          it:"Ciò che sfinisce un cavallo in un cross, quanto l'altezza degli ostacoli. Si risparmia il cavallo all'inizio e si recupera tempo in piano.",
          de:"Was ein Pferd im Gelände erschöpft, ebenso wie die Höhe der Sprünge. Man schont das Pferd am Anfang und holt die Zeit im Flachen.",
          ja:"クロスカントリーでは、起伏は障害の高さと同じくらい馬を疲れさせます。序盤は馬を節約し、平坦な区間で時間を取り戻します。",
          ar:"⚠️ يشكل الصعود والهبوط تحديا كبيرا للياقة الحصان وإدارة جهده في اختراق الضاحية. وتشتهر بادمينتون وبيرغلي بمسارات كثيرة التفاوت في الارتفاع، لذلك يجب توزيع جهد الحصان بحسب تضاريس المسار وحالة الأرض. ⚠️ وفي الإنجليزية يدل **hilly ground** على شكل التضاريس، بينما يدل «the going» على حالة سطح الأرض." } },
  ...
  { ref:"rattraper-temps", lecon:2, coll:"complet",
    ...
    def:{ fr:"⚠️ On ne rattrape PAS du temps en allant plus vite entre deux obstacles difficiles : on le rattrape sur les longues lignes droites et en ne perdant rien dans les tournants. La formule anglaise **to make up time** s'entend sur tous les crossses du monde, et son contraire est *to be behind the clock*.",
          ...
          ar:"⚠️ لا تحاولي تعويض الوقت في المناطق الفنية أو قبل الحواجز الصعبة. يمكن توفيره بأمان أكبر على الخطوط المستقيمة المناسبة، وباختيار مسار فعال، وبالحفاظ على التوازن والإيقاع في المنعطفات." } },
  ...
  { ref:"garder-les-barres", lecon:2, coll:"complet",
    ...
    def:{ fr:"🟥 L'ENJEU DU TROISIÈME JOUR, et la formule exacte des coachs : **keep the poles up**. Le parcours d'obstacle d'un complet se court sur un cheval qui a couru le cross la veille — il est fatigué, ses barres tombent plus facilement, et un sans-faute peut retourner tout le classement. ⚠️ Ce n'est pas la même équitation qu'un concours de saut : on ne cherche pas la vitesse, on cherche à ne rien faire tomber.",
          ...
          ar:"🟥 رهان الاختبار الأخير في بادمينتون، وتقول المدربة بالإنجليزية **keep the poles up**، أي «لا تسقطي العوارض». يخوض الحصان جولة قفز الحواجز بعد الجهد الذي بذله في اختراق الضاحية، وقد يصبح أقل نشاطا أو دقة. لذلك تستطيع جولة من دون أخطاء قلب الترتيب. ولا يكون الهدف هنا البحث عن السرعة القصوى، بل إنهاء الجولة بأقل عدد ممكن من الأخطاء." } },
  ...
  { ref:"carton-jaune", lecon:2, coll:"complet",
    mots:{ fr:{m:"le carton jaune"}, en:{m:"the yellow warning card", p:"yè-lô ouor-ning karde"},
           ...
           ar:{m:"البطاقة التحذيرية الصفراء"} },
    def:{ fr:"Il existe vraiment en équitation, et pas seulement au football : le jury le donne pour équitation dangereuse ou mauvais traitement d'un cheval. Deux cartons dans le délai fixé par le règlement de la fédération, et le cavalier peut être suspendu.",
          en:"It really exists in equestrian sport: the ground jury gives it for dangerous riding or abuse of a horse. Two within the period set by the federation's rules can mean suspension.",
          es:"Existe de verdad en equitación, y no solo en fútbol: el jurado lo da por equitación peligrosa o maltrato de un caballo. Dos tarjetas en el plazo fijado por el reglamento de la federación, y el jinete puede quedar suspendido.",
          it:"Esiste davvero in equitazione, e non solo nel calcio: la giuria la dà per equitazione pericolosa o maltrattamento di un cavallo. Due cartellini nel periodo fissato dal regolamento della federazione, e il cavaliere può essere sospeso.",
          de:"Sie existiert wirklich im Reitsport, nicht nur im Fußball: Die Jury zeigt sie für gefährliches Reiten oder schlechte Behandlung eines Pferdes. Zwei Karten innerhalb der Frist des Verbandsreglements — der Reiter kann gesperrt werden.",
          ja:"馬術にも本当に存在します。サッカーだけではありません。危険騎乗や馬の虐待に対して審判団が出します。連盟の規則が定める期間内に二枚で、騎手は出場停止になることがあります。",
          ar:"تستخدم البطاقة التحذيرية الصفراء في الفروسية عند بعض المخالفات، ومنها الركوب الخطر أو إساءة معاملة الحصان. وقد يؤدي تلقي بطاقتين خلال المدة المحددة في لوائح الاتحاد المعني إلى إيقاف الفارس." } },
  ...
  { ref:"niveau", lecon:2, coll:"complet",
    mots:{ fr:{m:"le niveau"}, en:{m:"the level", p:"lè-veul", var:"BE90 · Novice · Intermediate (GB)"},
           ...
           ar:{m:"المستوى"} },
    def:{ fr:"⚠️ Le vrai casse-tête du cavalier voyageur : les niveaux ne se traduisent pas. La France classe en Club / Amateur / Pro, la Grande-Bretagne en BE90, BE100, Novice, Intermediate, Advanced — où **Novice n'est pas un niveau de débutant** mais déjà 1,10 m. L'Allemagne numérote de E à S. Compare le niveau à la hauteur des obstacles et aux exigences de l'épreuve — jamais au seul nom.",
          en:"Levels do not translate. Britain's « Novice » is not a beginner level but already 1.10 m. Compare the level with the fence height and the demands of the class — never with the name alone.",
          es:"⚠️ El verdadero rompecabezas del jinete viajero: los niveles no se traducen. Francia clasifica en Club / Amateur / Pro, Gran Bretaña en BE90, BE100, Novice, Intermediate, Advanced — donde **Novice no es un nivel de principiante** sino ya 1,10 m. Alemania numera de E a S. Compara el nivel con la altura de los obstáculos y las exigencias de la prueba — jamás con el nombre solo.",
          it:"⚠️ Il vero rompicapo del cavaliere viaggiatore: i livelli non si traducono. La Francia classifica in Club / Amateur / Pro, la Gran Bretagna in BE90, BE100, Novice, Intermediate, Advanced — dove **Novice non è un livello da principiante** ma già 1,10 m. La Germania numera da E a S. Confronta il livello con l'altezza degli ostacoli e le esigenze della prova — mai col solo nome.",
          de:"⚠️ Das wahre Kopfzerbrechen des reisenden Reiters: Niveaus lassen sich nicht übersetzen. Frankreich stuft in Club / Amateur / Pro, Großbritannien in BE90, BE100, Novice, Intermediate, Advanced — wobei **Novice kein Anfängerniveau** ist, sondern schon 1,10 m. Deutschland zählt von E bis S. Vergleiche die Klasse mit Hindernishöhe und Anforderungen der Prüfung — nie nur mit dem Namen.",
          ja:"⚠️ 旅する騎手の本当の難問：レベルは翻訳できません。フランスは Club / Amateur / Pro、イギリスは BE90、BE100、Novice、Intermediate、Advanced — しかも **Novice は初心者レベルではなく**、もう1.1mの世界。ドイツはEからSまでの等級制。比べるなら障害の高さと競技の要求内容で。名前だけでは決して。",
          ar:"⚠️ اللغز الحقيقي للفارس المسافر: المستويات لا تترجم. فرنسا تصنف Club / Amateur / Pro، وبريطانيا BE90 وBE100 وNovice وIntermediate وAdvanced — حيث **Novice ليس مستوى مبتدئين** بل 1,10 م بالفعل. وألمانيا ترقم من E إلى S. لذلك قارني المستوى بارتفاع الحواجز ومتطلبات الاختبار، ولا تعتمدي على ترجمة اسم الفئة وحده." } },
  { ref:"speaker", lecon:3, coll:"jour-j",
    ...
    def:{ fr:"⚠️ Mot britannique impossible à deviner : **the tannoy**, du nom d'un fabricant de haut-parleurs, désigne toute la sonorisation d'un concours. « It came over the tannoy » veut dire « ça a été annoncé ».",
          ...
          ar:"⚠️ مصطلح بريطاني يصعب تخمينه: **tannoy**، وهو في الأصل اسم شركة لمكبرات الصوت، ويستخدم للدلالة على نظام الصوت في موقع المسابقة. وتعني عبارة «It came over the tannoy» أن المعلومة أعلنت عبر مكبرات الصوت." } },
  ...
  { ref:"appel", lecon:3, coll:"jour-j",
    ...
    def:{ fr:"Le moment où le commissaire t'appelle pour entrer en piste. Les deux phrases à reconnaître d'urgence en anglais : **« you're next »** et **« you're on »** — la seconde veut dire maintenant.",
          ...
          ar:"اللحظة التي يناديك فيها مشرف الدخول لتدخلي الميدان. ومن العبارات الإنجليزية التي يجب تمييزها فورا **you're next**، أي «أنت التالية»، و**you're on**، أي «حان دورك الآن»." } },
  ...
  { ref:"resultat", lecon:3, coll:"jour-j",
    ...
    def:{ fr:"Affiché au tableau, rarement annoncé. En complet, il s'exprime en points de pénalité cumulés sur les trois tests, et le meilleur score est le plus bas — l'inverse du dressage seul.",
          ...
          ar:"تظهر النتيجة عادة على لوحة النتائج، ونادرا ما تعلن عبر مكبرات الصوت. وفي الفروسية الثلاثية تحسب النتيجة من مجموع الجزاءات المتراكمة في الاختبارات الثلاثة، ويفوز أقل مجموع." } },
  ...
  { ref:"remise-prix", lecon:3, coll:"jour-j",
    ...
    def:{ fr:"À cheval le plus souvent, cocarde au frontal. Y aller compte : un classé absent fait attendre tout le monde, et c'est très mal vu partout.",
          ...
          ar:"يقام حفل توزيع الجوائز على صهوة الخيل في كثير من المسابقات، وتثبت شارة الفوز على رباط جبهة اللجام. والحضور مهم، لأن غياب فارسة مصنفة قد يؤخر المراسم ويعد تصرفا غير لائق." } },
  ...
  { ref:"groom", lecon:3, coll:"jour-j",
    mots:{ fr:{m:"le groom"}, en:{m:"the groom", p:"groum"},
           ...
           ar:{m:"مسؤول رعاية الحصان (السائس)"} },
    def:{ fr:"⚠️ Piège grammatical parfait : en anglais, **groom** est la *personne* qui s'occupe du cheval, alors que *to groom* est le geste de panser (chapitre 2). « My groom is holding him » ne veut pas dire qu'on le brosse.",
          ...
          ar:"⚠️ في الإنجليزية، **groom** اسم للشخص الذي يعتني بالحصان، بينما يعني الفعل *to groom* تنظيف الحصان والعناية به. لذلك لا تعني عبارة «My groom is holding him» أن الحصان ينظف بالفرشاة." } },
  ...
  { ref:"formats-complet", lecon:2, coll:"concours",
    mots:{ fr:{m:"le format"}, en:{m:"the format", p:"for-matt"},
           ...
           ar:{m:"صيغة المسابقة"} },
    def:{ fr:"Le complet se court en un jour (**ODE**, one-day event) ou sur plusieurs (**le three-day event**, qui peut s'étendre aujourd'hui sur quatre jours). En international : **CCI-S** (court) et **CCI-L** (long) — ⚠️ les anciens sigles **CIC/CCI**, renommés en 2019, s'entendent encore partout. La difficulté se lit aux étoiles, de 1★ à 5★ : Badminton est un 5★, il n'en existe qu'une poignée au monde.",
          en:"Eventing runs over one day (**ODE**, one-day event) or several (**the three-day event**, which can now stretch to four days). Internationally: **CCI-S** (short) and **CCI-L** (long) — the old labels **CIC/CCI**, renamed in 2019, are still heard everywhere. Difficulty reads in stars, 1★ to 5★: Badminton is a 5★, and there is only a handful in the world.",
          es:"El completo se corre en un día (**ODE**, one-day event) o en varios (**el three-day event**, que hoy puede extenderse a cuatro días). En internacional: **CCI-S** (corto) y **CCI-L** (largo) — ⚠️ las siglas antiguas **CIC/CCI**, renombradas en 2019, aún se oyen en todas partes. La dificultad se lee en estrellas, de 1★ a 5★: Badminton es un 5★, y solo hay un puñado en el mundo.",
          it:"Il completo si corre in un giorno (**ODE**, one-day event) o su più giorni (**il three-day event**, che oggi può estendersi a quattro). In internazionale: **CCI-S** (corto) e **CCI-L** (lungo) — ⚠️ le vecchie sigle **CIC/CCI**, rinominate nel 2019, si sentono ancora ovunque. La difficoltà si legge nelle stelle, da 1★ a 5★: Badminton è un 5★, e ne esiste una manciata al mondo.",
          de:"Die Vielseitigkeit läuft an einem Tag (**ODE**, one-day event) oder an mehreren (**das Three-Day-Event**, heute mitunter vier Tage). International: **CCI-S** (kurz) und **CCI-L** (lang) — ⚠️ die alten Kürzel **CIC/CCI**, 2019 umbenannt, hört man noch überall. Die Schwierigkeit steht in Sternen, 1★ bis 5★: Badminton ist ein 5★ — davon gibt es weltweit eine Handvoll.",
          ja:"総合馬術は一日で行う **ODE**（ワンデイイベント）と、複数日にわたる **three-day event**（今日では四日間に及ぶこともあります）があります。国際競技では **CCI-S**（ショート）と **CCI-L**（ロング）— ⚠️ 2019年に改称された旧称 **CIC/CCI** も、現場ではまだあちこちで聞こえます。難易度は 1★ から 5★ の星の数で読みます。バドミントンは 5★ — 世界に一握りしかない格付けです。",
          ar:"يمكن تنظيم الفروسية الثلاثية في يوم واحد أو على عدة أيام. وعلى المستوى الدولي توجد صيغة قصيرة **CCI-S** وصيغة طويلة **CCI-L**. وما زالت الرموز القديمة **CIC** و**CCI** تسمع أحيانا رغم تغيير التصنيف في عام 2019. ويشار إلى مستوى الصعوبة بعدد النجوم من نجمة إلى خمس نجوم، وبادمينتون بطولة من فئة خمس نجوم." } }
  ],
  ...
  phrases: [
    { ref:"niveau-equivalent", lecon:2,
      ...
      ja:"ノービス は 高さ いくつ です か ?",
        ar:"ما ارتفاع الحواجز في مستوى Novice؟" },
    { ref:"temps-optimum-cross", lecon:2,
      ...
      ja:"規定 タイム は 六分 二十秒。",
        ar:"الزمن المستهدف لاختراق الضاحية: ست دقائق وعشرون ثانية." },
  ...
  dialogue: {
    ville: "badminton", lecon: 2, temps: 6, langues: ["fr","en","es","it","de","ja","ar"],   /* 27 phrases */
    ...
    phrases: [
      ...
      { ref:"dbd-secretariat", temps:1, dit:"joueuse", mots:[], motsAilleurs:["secretariat"],
        ...
        ar:"أين مكتب التسجيل؟ جئت لاستلام رقم مشاركتي." },
      ...
      { ref:"dbd-r-licence-passeport", temps:1, dit:"club", mots:[], motsAilleurs:["licence"],
        ...
        ar:"أحتاج إلى رخصة الفروسية وجواز سفر الحصان." },
      ...
      { ref:"dbd-licence-etrangere", temps:1, dit:"joueuse", mots:[], motsAilleurs:["licence"],
        ...
        ar:"رخصتي أجنبية، فهل هي صالحة هنا؟" },
      ...
      { ref:"dbd-epreuves-ou", temps:1, dit:"joueuse", mots:["concours-complet","reprise-dressage","parcours-obstacle","cross"],
        ...
        ar:"أين ستجرى اختبارات الترويض وقفز الحواجز واختراق الضاحية، وما برنامجها؟" },
      ...
      { ref:"dbd-r-trois-jours", temps:1, dit:"club", mots:["reprise-dressage","cross","parcours-obstacle"],
        ...
        ar:"الترويض اليوم، واختراق الضاحية غدا، وقفز الحواجز يوم الأحد." },
      ...
      { ref:"dbd-r-laisse-respirer", temps:2, dit:"club", mots:["reprise-dressage"],
        ...
        ar:"إنه متوتر قليلا، فاتركيه يهدأ ويلتقط أنفاسه قبل الدخول إلى ميدان الترويض." },
      ...
      { ref:"dbd-r-transition-lettre", temps:2, dit:"club", mots:[], motsAilleurs:["lettre"],
        ...
        ar:"حضري الانتقال قبل الوصول إلى الحرف، لا في اللحظة الأخيرة." },
      ...
      { ref:"dbd-r-cadence-reguliere", temps:2, dit:"club", mots:[], motsAilleurs:["cadence"],
        ...
        ar:"حافظي على إيقاع منتظم ولا تدعيه يسرع." },
      ...
      { ref:"dbd-r-engagement", temps:2, dit:"club", mots:["reprise-dressage"], motsAilleurs:["engagement"],
        ...
        ar:"نحتاج في هذا الاختبار إلى مزيد من تقدم القوائم الخلفية تحت جسم الحصان." },
      ...
      { ref:"dbd-troisieme-provisoire", temps:2, dit:"joueuse", mots:["classement-provisoire","reprise-dressage"],
        ...
        ja:"馬場 の あと、 暫定 三位 です。",
        ar:"أنا ثالثة في الترتيب المؤقت بعد الترويض." },
      ...
      { ref:"dbd-r-terrain-vallonne", temps:3, dit:"club", mots:["terrain-vallonne","cross"],
        ...
        ar:"المسار كثير الصعود والهبوط، فوزعي جهد حصانك في بداية اختبار اختراق الضاحية." },
      ...
      { ref:"dbd-r-galoper-recuperer", temps:3, dit:"club", mots:["rattraper-temps"],
        ...
        ar:"دعيه يحافظ على عدو منتظم في الأجزاء التي يمكنك فيها تعويض الوقت بأمان." },
      ...
      { ref:"dbd-r-rebalance-galop", temps:3, dit:"club", mots:["obstacle-fixe"],
        ...
        ar:"أعيدي توازنه قبل الحاجز الكبير، لكن حافظي على نشاط العدو وإيقاعه." },
      ...
      { ref:"dbd-r-regarde-suivant", temps:3, dit:"club", mots:[], motsAilleurs:["ligne"],
        ...
        ar:"وجهي نظرك إلى الحاجز التالي بينما تجتازين الحاجز الحالي." },
      ...
      { ref:"dbd-r-drop-dans-eau", temps:3, dit:"club", mots:[], motsAilleurs:["contre-bas","complexe-eau"],
        ...
        ar:"هناك نزول كبير إلى الماء، فحافظي على توازنك وأبقي جذعك خلف حركة الحصان من دون أن تشدي الأعنة." },
      ...
      { ref:"dbd-r-jambes-fosse", temps:3, dit:"club", mots:[], motsAilleurs:["fosse"],
        ...
        ar:"أبقي ساقيك ملاصقتين لجانبيه إذا تردد أمام الخندق." },
      ...
      { ref:"dbd-r-voie-directe-precision", temps:3, dit:"club", mots:[], motsAilleurs:["voie-directe"],
        ...
        ar:"المسار المباشر أسرع، لكنه يتطلب دقة كبيرة." },
      ...
      { ref:"dbd-r-pas-couper-virage", temps:3, dit:"club", mots:[], motsAilleurs:["ligne"],
        ...
        ar:"لا تختصري المنعطف أكثر من اللازم، فقد تفقدين استقامة خطك نحو العنصر الثاني." },
      ...
      { ref:"dbd-r-trouve-sa-foulee", temps:3, dit:"club", mots:["obstacle-fixe"],
        ...
        ar:"دعيه ينظم خطواته ويجد نقطة الارتقاء المناسبة أمام حاجز الأوكسير الكبير في مسار اختراق الضاحية." },
      ...
      { ref:"dbd-r-retard-chrono", temps:3, dit:"club", mots:["temps-optimum","rattraper-temps"],
        ...
        ar:"نحن متأخرون قليلا عن الزمن المستهدف، لذلك نحتاج الآن إلى التقدم بنشاط." },
      ...
      { ref:"dbd-r-donne-hier", temps:4, dit:"club", mots:[], motsAilleurs:["detente"],
        ...
        ar:"لقد بذل جهدا كبيرا أمس، فراقبي حالته واستجابته أثناء الإحماء." },
      ...
      { ref:"dbd-r-garder-les-barres", temps:5, dit:"club", mots:["garder-les-barres","parcours-obstacle","cross"],
        ...
        ar:"اليوم يجب تجنب إسقاط العوارض، فقد يكون الحصان متعبا بعد اختبار اختراق الضاحية." },
      ...
      { ref:"dbd-r-attends-distance", temps:5, dit:"club", mots:["parcours-obstacle"],
        ...
        ar:"انتظري نقطة الارتقاء المناسبة، وأبقيه مستقيما بين عنانيك." },
      ...
      { ref:"dbd-r-sans-faute-classement", temps:6, dit:"club", mots:["classement-provisoire"], motsAilleurs:["sans-faute"],
        ...
        ar:"جولة من دون أخطاء اليوم قد تغير الترتيب النهائي تماما." },
      ...
      { ref:"dbd-points-de-temps", temps:6, dit:"joueuse", mots:["temps-optimum","bareme"],
        ...
        ar:"هل أضيفت إلى نتيجتي جزاءات زمنية؟ وما طريقة احتساب النقاط المعمول بها هنا؟" },
      ...
      { ref:"dbd-r-remise-prix", temps:6, dit:"club", mots:[], motsAilleurs:["trophee"],
        ...
        ar:"حفل توزيع الجوائز في الساعة الرابعة عصرا. تعالي لاستلام كأسك ولوحة فوزك وشارة الترتيب." }
    ]
  }
};
