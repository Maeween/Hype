...
window.HYPE_LINGO_LEX.connemara = {
  ref: "connemara",
  titre: { fr:"Le cheval", en:"The horse", es:"El caballo", it:"Il cavallo", de:"Das Pferd", ja:"馬", ar:"الحصان" },
  lecons: 3,
  ...
  { ref:"robe", lecon:1, coll:"robes",
    ...
    def:{ fr:"La couleur du cheval : le premier mot d'un passeport ou d'une annonce. ⚠️ En anglais on ne demande jamais « what robe » mais « what colour is he ? ».",
          ...
          ar:"لون شعر الحصان، وهو من أول المعلومات المذكورة في جواز سفره أو في إعلان بيعه. ⚠️ في الإنجليزية لا يقال أبدا «what robe»، بل يقال «what colour is he?»." } },
  ...
  { ref:"bai", lecon:1, coll:"robes",
    ...
    def:{ fr:"Corps brun-rouge, crins et bas des membres noirs. La robe la plus répandue au monde. ⚠️ L'allemand la nomme par un nom, der Brauner, là où le français emploie un adjectif.",
          ...
          ar:"لون بني محمر للجسم، مع عرف وذيل وأسفل القوائم باللون الأسود. وهو من أكثر ألوان الخيل انتشارا في العالم. ⚠️ الألمانية تستعمل له اسما، der Brauner، بينما تستعمل الفرنسية صفة." } },
  ...
  { ref:"alezan", lecon:1, coll:"robes",
    ...
    def:{ fr:"Robe rousse uniforme, crins de la même teinte ou plus clairs. L'allemand dit « le renard », le japonais « poil de châtaigne ». Apy, la mascotte de Hype Baby, est alezan.",
          ...
          ar:"لون أحمر أو نحاسي متجانس، ويكون العرف والذيل من اللون نفسه أو أفتح. الألمانية تسميه «الثعلب»، واليابانية «شعر الكستناء». Apy، تميمة Hype Baby، أشقر اللون." } },
  ...
  { ref:"noir", lecon:1, coll:"robes",
    ...
    def:{ fr:"Noir jusqu'aux extrémités, sans reflet roux. ⚠️ Le japonais l'appelle « poil bleu » (青毛), parce qu'un vrai noir a des reflets bleutés au soleil. L'italien ne dit pas « nero » mais morello.",
          ...
          ar:"أسود حتى أطراف القوائم، من دون انعكاسات حمراء. ⚠️ تسميه اليابانية «الشعر الأزرق» (青毛)، لأن الأسود الحقيقي قد يعطي انعكاسات مزرقة تحت الشمس. أما الإيطالية فلا تستعمل nero بل morello." } },
  ...
  { ref:"gris", lecon:1, coll:"robes",
    ...
    def:{ fr:"Un gris naît foncé et blanchit avec l'âge. ⚠️ On ne dit jamais « blanc » : le cheval blanc de conte de fées est un gris âgé. L'espagnol emploie tordo, pas gris, dans le langage technique.",
          ...
          ar:"يولد الحصان الأشهب بلون داكن ثم يفتح لونه تدريجيا مع العمر. ⚠️ لا يسمى «أبيض»: فالحصان الأبيض في القصص يكون في الغالب حصانا أشهب متقدما في السن. وفي المصطلحات الإسبانية يستعمل tordo لا gris." } },
  ...
  { ref:"pie", lecon:1, coll:"robes",
    mots:{ fr:{m:"le pie"}, en:{m:"piebald", p:"païe-bôld", var:"skewbald · coloured (GB) · pinto (US)"},
           ...
           ar:{m:"الأبقع"} }, /* ja corrige (rapport 07/08) : usage elevage/courses */
    def:{ fr:"Grandes plaques blanches sur une autre robe. ⚠️ L'anglais est la seule langue à couper la robe en deux : **piebald** = noir et blanc, **skewbald** = toute autre couleur et blanc. En Grande-Bretagne, on dit souvent simplement « a coloured ».",
          ...
          ar:"مساحات بيضاء كبيرة فوق لون أساسي آخر. ⚠️ الإنجليزية تميز بين نوعين: **piebald** للأسود والأبيض، و**skewbald** لأي لون آخر مع الأبيض. وفي بريطانيا يقال كثيرا ببساطة «a coloured»." } },
  ...
  { ref:"isabelle", lecon:1, coll:"robes",
    mots:{ fr:{m:"l'isabelle"}, en:{m:"dun", p:"deune"},
           ...
           ar:{m:"الأصفر الرملي"} }, /* valide (rapport 07/08) */
    def:{ fr:"Robe sable à dorée, crins foncés, souvent une raie de mulet sur le dos. Le japonais a un mot pour elle parce que ses poneys indigènes la portent.",
          ...
          ar:"لون يتراوح من الرملي إلى الذهبي، مع عرف وذيل داكنين، وغالبا خط داكن يمتد على الظهر. ولليابانية مصطلح خاص به لأن بعض سلالات الخيل المحلية تحمل هذا اللون." } },
  ...
  { ref:"palomino", lecon:1, coll:"robes",
    ...
    def:{ fr:"Robe dorée à crinière et queue blanches. Le mot est espagnol et a voyagé tel quel dans presque toutes les langues — sauf en japonais, qui dit « poil de lune ».",
          ...
          ar:"لون ذهبي مع عرف وذيل أبيضين أو فاتحين جدا. الكلمة إسبانية وانتقلت كما هي تقريبا إلى معظم اللغات — باستثناء اليابانية التي تسميه «شعر القمر»." } },
  ...
  { ref:"rouan", lecon:1, coll:"robes",
    ...
    def:{ fr:"Des poils blancs mêlés à la robe de base, dès la naissance et sans jamais s'étendre. C'est ce qui le distingue du gris, qui blanchit toute sa vie.",
          ...
          ar:"شعيرات بيضاء مختلطة باللون الأساسي منذ الولادة، من دون أن يزداد انتشارها تدريجيا. وهذا ما يميزه عن الأشهب الذي يفتح لونه مع التقدم في العمر." } },
  ...
  { ref:"blanc", lecon:1, coll:"robes",
    ...
    def:{ fr:"⚠️ Le piège classique. Un cheval « blanc » est presque toujours un gris blanchi. Le blanc véritable naît blanc et reste rarissime — l'allemand a un mot exprès pour lui : der Weißgeborene, « le né-blanc ».",
          ...
          ar:"⚠️ الفخ التقليدي: الحصان الذي يبدو «أبيض» يكون في معظم الحالات أشهب أصبح فاتحا جدا مع العمر. أما الأبيض الحقيقي فيولد أبيض ويبقى نادرا جدا — وللألمانية مصطلح خاص به: der Weißgeborene، أي «المولود أبيض»." } },
  ...
  { ref:"liste", lecon:2, coll:"marques",
    ...
    def:{ fr:"La bande blanche qui descend du front vers le nez. Apy en a une très large, continue jusqu'au museau. Le japonais l'appelle « étoile filante » (流星).",
          ...
          ar:"شريط أبيض يمتد من الجبهة نحو الأنف. لدى Apy غرة عريضة جدا تمتد بشكل متصل حتى مقدمة الأنف. واليابانية تسميها «نجمة ساقطة» (流星)." } },
  ...
  { ref:"etoile", lecon:2, coll:"marques",
    ...
    def:{ fr:"La petite marque blanche du front, isolée. Toutes les langues ont choisi la même image, ce qui en fait le mot le plus facile du chapitre.",
          ...
          ar:"علامة بيضاء صغيرة ومنفصلة على الجبهة. جميع اللغات تقريبا اختارت صورة «النجمة»، ولذلك فهي من أسهل كلمات هذا الفصل." } },
  ...
  { ref:"balzane", lecon:2, coll:"marques",
    mots:{ fr:{m:"la balzane"}, en:{m:"the sock", p:"soque", var:"stocking = haute"},
           ...
           ar:{m:"العلامة البيضاء على القائمة"} }, // ??
    def:{ fr:"Le blanc sur un membre. ⚠️ Chaque langue compte différemment : l'anglais oppose sock (basse) et stocking (haute), l'allemand nomme la hauteur exacte atteinte (Krone, Fessel, Röhre), et le japonais compte les membres (一白 = un membre blanc).",
          ...
          ar:"اللون الأبيض على إحدى قوائم الحصان. ⚠️ تختلف طريقة وصفه من لغة إلى أخرى: الإنجليزية تميز بين sock للعلامة القصيرة وstocking للعلامة العالية، والألمانية تسمي الارتفاع الذي تصل إليه العلامة بدقة، أما اليابانية فتحسب عدد القوائم البيضاء." } },
  ...
  { ref:"epi", lecon:2, coll:"marques",
    ...
    def:{ fr:"Le tourbillon de poils, le plus souvent au milieu du front. Unique à chaque cheval : il figure sur le signalement du passeport, comme une empreinte digitale.",
          ...
          ar:"دوامة في اتجاه الشعر، تكون غالبا في منتصف الجبهة. وهي فريدة لكل حصان، ولذلك تسجل في وصف جواز السفر مثل بصمة الإصبع." } },
  ...
  { ref:"puce", lecon:2, coll:"marques",
    ...
    def:{ fr:"Obligatoire en Europe, posée dans l'encolure gauche. C'est elle qui relie physiquement le cheval à son passeport.",
          ...
          ar:"إلزامية في أوروبا، وتزرع عادة في الجهة اليسرى من العنق. وهي الوسيلة التي تربط هوية الحصان فعليا بجواز سفره." } },
  ...
  { ref:"passeport", lecon:2, coll:"marques",
    ...
    def:{ fr:"Le document qui suit le cheval partout : signalement dessiné, épis, balzanes, vaccins, numéro de puce. Contrôlé à l'entrée des concours, et exigé pour les transports selon la réglementation du pays traversé.",
          ...
          ar:"الوثيقة التي ترافق الحصان أينما ذهب: وصف العلامات المرسومة، ودوامات الشعر، والعلامات البيضاء على القوائم، واللقاحات، ورقم الشريحة الإلكترونية. ويتم التحقق منها في المسابقات وأثناء النقل." } },
  ...
  { ref:"taille", lecon:2, coll:"marques",
    ...
    def:{ fr:"⚠️ Le piège de voyage numéro un. La Grande-Bretagne et l'Irlande mesurent en **hands** : une hand vaut 10,16 cm, et « he's 16.2 » veut dire 16 hands et 2 pouces, soit 1,68 m. Le reste de l'Europe mesure en centimètres au garrot.",
          ...
          ar:"⚠️ من أهم فخاخ السفر. في بريطانيا وأيرلندا يقاس ارتفاع الحصان بوحدة **hand**: اليد الواحدة تساوي 10,16 سم، و«he's 16.2» تعني 16 يدا وبوصتين، أي نحو 1,68 م. أما معظم أوروبا فتستعمل السنتيمترات عند الحارك." } },
  ...
  { ref:"poney", lecon:2, coll:"marques",
    ...
    def:{ fr:"Sous 1,48 m au garrot (1,49 m ferré), c'est un poney ; au-dessus, un cheval. Un Connemara tombe souvent pile sur la limite, ce qui décide de sa catégorie en concours.",
          ...
          ar:"إذا كان الارتفاع عند الحارك أقل من 1,48 م — أو 1,49 م مع الحدوات — يصنف الحيوان بوني، وما فوق ذلك يصنف حصانا. وكثير من خيول كونيمارا تقع تماما قرب هذا الحد، وهو ما يحدد فئتها في المسابقات." } },
  ...
  { ref:"fer", lecon:2, coll:"marques",
    ...
    def:{ fr:"Cloué dans la paroi du sabot, qui n'est pas sensible. Un cheval peut aussi vivre pieds nus : on dit alors qu'il est déferré.",
          ...
          ar:"تثبت بالمسامير في جدار الحافر، وهو الجزء غير الحساس. ويمكن أيضا أن يعيش الحصان من دون حدوات؛ وعندها يقال إنه غير منتعل أو حافي الحوافر." } },
  ...
  { ref:"marechal", lecon:2, coll:"marques",
    ...
    def:{ fr:"Il passe toutes les six à huit semaines. ⚠️ Ne pas dire « blacksmith » : le blacksmith travaille le fer, le farrier travaille le pied. Le mot anglais n'a aucune parenté avec le français.",
          ...
          ar:"يأتي عادة كل ستة إلى ثمانية أسابيع. ⚠️ لا تخلطي في الإنجليزية بين **blacksmith** و**farrier**: الأول يعمل بالحديد عموما، أما farrier فيعمل على حوافر الخيل." } },
  ...
  { ref:"tete", lecon:3, coll:"morpho",
    ...
    def:{ fr:"On l'approche par l'épaule, jamais de face : le cheval voit mal juste devant son nez.",
          ...
          ar:"يقترب من الحصان من جهة الكتف، لا مباشرة من الأمام، لأن رؤيته محدودة جدا في المنطقة الواقعة مباشرة أمام أنفه." } },
  ...
  { ref:"garrot", lecon:3, coll:"morpho",
    ...
    def:{ fr:"Le sommet de l'épaule, point fixe du corps : c'est là qu'on mesure le cheval et là que se pose l'avant de la selle. L'espagnol l'appelle « la croix ».",
          ...
          ar:"أعلى نقطة فوق الكتفين، وهي نقطة مرجعية ثابتة في جسم الحصان: عندها يقاس ارتفاعه، وقربها يستقر الجزء الأمامي من السرج. والإسبانية تسميها «الصليب»." } },
  ...
  { ref:"epaule", lecon:3, coll:"morpho",
    ...
    def:{ fr:"Son inclinaison décide de l'amplitude des allures. Une épaule droite donne un cheval qui trotte court.",
          ...
          ar:"تؤثر زاوية الكتف في اتساع الخطوات. فالكتف الأكثر استقامة غالبا ما يرتبط بخطوات أقصر، ولا سيما في الخبب." } },
  ...
  { ref:"croupe", lecon:3, coll:"morpho",
    ...
    def:{ fr:"Le moteur du cheval. On ne passe jamais derrière sans avoir parlé : c'est l'angle mort et la zone du coup de pied.",
          ...
          ar:"محرك الحصان. لا تمري خلفه من دون تنبيهه بصوتك، فهذه منطقة عمياء وقد تكون في مدى رفس القوائم الخلفية." } },
  ...
  { ref:"jarret", lecon:3, coll:"morpho",
    ...
    def:{ fr:"La grande articulation coudée du postérieur, celle qui pousse. Chaque langue lui a donné un mot court et propre : hock, Sprunggelenk, corvejón, garretto, 飛節.",
          ...
          ar:"المفصل الكبير ذو الزاوية في القائمة الخلفية، وهو من أهم المفاصل المسؤولة عن الدفع. ولكل لغة تقريبا مصطلح خاص به: hock، Sprunggelenk، corvejón، garretto، 飛節." } },
  ...
  { ref:"boulet", lecon:3, coll:"morpho",
    ...
    def:{ fr:"L'articulation en boule au-dessus du paturon. C'est là qu'on pose les guêtres et qu'on cherche une chaleur suspecte.",
          ...
          ar:"المفصل المستدير فوق السلامية مباشرة. توضع حول هذه المنطقة كثير من واقيات القوائم، كما تفحص باليد للبحث عن حرارة غير طبيعية." } },
  ...
  { ref:"paturon", lecon:3, coll:"morpho",
    ...
    def:{ fr:"Entre le boulet et le sabot. Long et souple, il amortit ; court et droit, il tape. ⚠️ Attention en allemand : Fessel désigne le paturon, et Fesselgelenk le boulet.",
          ...
          ar:"الجزء بين المفصل والحافر. إذا كان طويلا ومرنا ساعد على امتصاص الصدمات؛ وإذا كان قصيرا ومستقيما نقل صدمات أكبر إلى القائمة. ⚠️ في الألمانية Fessel تعني هذه المنطقة، بينما Fesselgelenk هو المفصل فوقها." } },
  ...
  { ref:"ventre", lecon:3, coll:"morpho",
    ...
    def:{ fr:"À vérifier au pansage : c'est là que se cachent les tiques et que la sangle blesse.",
          ...
          ar:"من المناطق التي يجب فحصها أثناء التنظيف: فقد تختبئ فيها القرادات، كما قد يسبب حزام السرج احتكاكات أو جروحا فيها." } },
  ...
  { ref:"naseaux", lecon:3, coll:"morpho",
    ...
    def:{ fr:"Le cheval ne respire que par le nez, jamais par la bouche. Des naseaux très dilatés après l'effort sont normaux ; au repos, ils inquiètent.",
          ...
          ar:"الحصان يتنفس عن طريق الأنف فقط، ولا يتنفس عن طريق الفم. اتساع المنخرين بعد المجهود أمر طبيعي، أما اتساعهما بشكل واضح أثناء الراحة فقد يكون علامة تستدعي الانتباه." } },
  ...
  { ref:"oreilles", lecon:3, coll:"morpho",
    ...
    def:{ fr:"Le premier indicateur d'humeur, et le plus universel : couchées en arrière, on s'écarte, dans toutes les langues et tous les pays.",
          ...
          ar:"من أوضح مؤشرات مزاج الحصان وأكثرها عالمية: إذا التصقت الأذنان إلى الخلف بشدة، فمن الأفضل الابتعاد والانتباه — وهذه الإشارة مفهومة في جميع البلدان." } },
    ...
    "gb-irl": [
      ...
      { ref:"pur-sang", coll:"races", pays:"gb-irl",
        ...
        def:{ fr:"Né en Angleterre au XVIIIᵉ siècle de trois étalons orientaux. Le cheval de course par excellence — c'est lui qu'on voit s'entraîner à Newmarket et à Lambourn. ⚠️ Toujours avec une majuscule en anglais.",
          ...
          ar:"نشأ في إنجلترا في القرن الثامن عشر انطلاقا من ثلاثة فحول شرقية. وهو حصان السباقات الأشهر على الإطلاق — وهو الذي تشاهدينه يتدرب في Newmarket وLambourn. ⚠️ يكتب اسمه بالإنجليزية دائما بحرف كبير: Thoroughbred." } },
      ...
      { ref:"connemara", coll:"races", pays:"gb-irl",
        ...
        def:{ fr:"Le poney irlandais du comté de Galway, gris le plus souvent, sûr et sauteur. Souvent pile à la limite des 1,48 m, ce qui en fait autant un poney de club qu'un cheval de concours.",
          ...
          ar:"بوني أيرلندي من مقاطعة Galway، وغالبا ما يكون أشهب اللون، ثابت القدم وموهوبا في القفز. ويقع كثيرا قرب حد 1,48 م، لذلك يمكن أن يكون بوني نادي ممتازا ومنافسا رياضيا حقيقيا في الوقت نفسه." } },
      ...
      { ref:"welsh-cob", coll:"races", pays:"gb-irl",
        ...
        def:{ fr:"Le plus grand des quatre types gallois (section D), trapu, énergique, au trot très relevé. Le poney gallois se décline en sections A, B, C et D, de la plus petite à la plus grande.",
          ...
          ar:"أكبر الأنواع الويلزية الأربعة، وهو Section D. قوي البنية ونشيط وله حركة خبب مرتفعة وواضحة. وتقسم خيول البوني الويلزية إلى الفئات A وB وC وD من الأصغر إلى الأكبر." } },
      ...
      { ref:"irish-draught", coll:"races", pays:"gb-irl",
        ...
        def:{ fr:"Le cheval de ferme irlandais, puissant mais pas lourd, à l'origine de tous les bons chevaux de concours du pays. ⚠️ Draught ne veut pas dire « trait » au sens du Percheron : il monte très bien.",
          ...
          ar:"حصان المزارع الأيرلندي، قوي من دون أن يكون ثقيلا، وكان أساسا وراثيا مهما لكثير من خيول الرياضة الأيرلندية. ⚠️ كلمة Draught هنا لا تعني بالضرورة حصان جر ثقيل مثل Percheron؛ فهو حصان يمكن ركوبه بكفاءة كبيرة." } },
      ...
      { ref:"irish-sport-horse", coll:"races", pays:"gb-irl",
        ...
        def:{ fr:"Le croisement Irish Draught × pur-sang : le meilleur cheval de concours complet du monde depuis des décennies. C'est le produit phare des haras de Kildare.",
          ...
          ar:"نتاج تهجين Irish Draught مع Thoroughbred، ومن أنجح خيول المسابقة الكاملة في العالم منذ عقود. وهو من أشهر منتجات تربية الخيل في Kildare." } },
      ...
      { ref:"cob-irlandais", coll:"races", pays:"gb-irl",
        ...
        def:{ fr:"Le cheval pie à longs fanons des gens du voyage irlandais. ⚠️ Cas de faux ami à l'envers : les pays germanophones l'appellent **Tinker**, un mot que les Irlandais eux-mêmes considèrent comme insultant. Dire Irish cob.",
          ...
          ar:"حصان غالبا ما يكون أبقع وله شعر كثيف وطويل حول أسفل القوائم، ارتبط تاريخيا بمجتمعات Travellers الأيرلندية. ⚠️ في بعض البلدان الناطقة بالألمانية يسمى **Tinker**، لكن هذا الاسم قد يعد مسيئا لدى الأيرلنديين أنفسهم؛ الأفضل استعمال Irish cob." } },
      ...
      { ref:"shetland", coll:"races", pays:"gb-irl",
        ...
        def:{ fr:"Le plus petit et le plus fort au monde en proportion, né des îles au nord de l'Écosse. Le premier poney de beaucoup d'enfants britanniques, et une force de caractère à la mesure de sa taille.",
          ...
          ar:"من أصغر سلالات البوني في العالم ومن أقواها نسبة إلى حجمها، وأصله من جزر شتلاند شمال اسكتلندا. وهو أول بوني يركبه كثير من الأطفال البريطانيين — وشخصيته قوية بقدر صغر حجمه." } },
      ...
      { ref:"shire", coll:"races", pays:"gb-irl",
        ...
        def:{ fr:"Le géant anglais, jusqu'à 1,90 m au garrot et une tonne : la plus grande race de chevaux du monde. Autrefois attelé aux brasseries, aujourd'hui sauvé par les passionnés.",
          ...
          ar:"العملاق الإنجليزي، وقد يصل ارتفاعه إلى 1,90 م عند الحارك ووزنه إلى نحو طن. يعد من أكبر سلالات الخيل في العالم. استعمل تاريخيا في جر عربات مصانع الجعة، واليوم يحافظ عليه المربون والهواة." } }
    ]
  },
  /* ---- phrases complètes ---- */
  phrases: [
    ...
    { ref:"jument-grise", lecon:1,
      ...
      ja:"芦毛 の 牝馬、 流星 つき。",
        ar:"فرس شهباء، ولديها غرة بيضاء طولية." },
  ...
  dialogue: {
    ...
    phrases: [
      ...
      { ref:"d-r-connemara-gris-barriere", temps:1, dit:"club", mots:["connemara","gris"],
        ...
        ar:"ستركبين بوني كونيمارا الأشهب القريب من البوابة." },
      ...
      { ref:"d-r-deux-balzanes", temps:1, dit:"club", mots:["balzane"],
        ...
        ar:"نعم، الذي لديه علامتان بيضاوان على قائمتين." },
      ...
      { ref:"d-r-gris-plus-fonce-jeune", temps:2, dit:"club", mots:["gris"],
        ...
        ar:"إنه أشهب. كان لونه أغمق بكثير عندما كان صغيرا." },
      ...
      { ref:"d-etoile-ou-liste", temps:2, dit:"joueuse", mots:["etoile","liste"],
        ...
        ar:"هل لديه نجمة أم غرة بيضاء طولية؟" },
      ...
      { ref:"d-r-liste-et-epi", temps:2, dit:"club", mots:["liste","epi"],
        ...
        ar:"لديه غرة بيضاء طولية، ولديه أيضا دوامة شعر في منتصف الجبهة." },
      ...
      { ref:"d-r-quatorze-deux", temps:3, dit:"club", mots:["taille"],
        ...
        ja:"十四 ハンド 二 です。",
        ar:"ارتفاعه أربع عشرة يدا وبوصتان." },
      ...
      { ref:"d-r-au-dessus-des-epaules", temps:4, dit:"club", mots:["epaule","garrot"],
        ...
        ar:"هنا تماما، فوق الكتفين. من هذه النقطة نقيس ارتفاع الحصان." },
      ...
      { ref:"d-r-main-derriere-epaule", temps:4, dit:"club", mots:["epaule"],
        ...
        ar:"مرري يدك خلف كتفه قبل وضع السرج." },
      ...
      { ref:"d-naseaux-ouverts", temps:5, dit:"joueuse", mots:["naseaux"],
        ...
        ar:"منخراه متسعان قليلا، هل هذا طبيعي؟" },
      ...
      { ref:"d-r-oreilles-humeur", temps:5, dit:"club", mots:["oreilles"],
        ...
        ar:"نعم، فقد كان يمشي للتو. راقبي أذنيه أيضا: فهما تخبرانك بالكثير عن مزاجه." },
      ...
      { ref:"d-r-cest-le-jarret", temps:6, dit:"club", mots:["jarret"],
        ...
        ar:"هذا هو العرقوب. وفي الإنجليزية يسمى «the hock»." },
      ...
      { ref:"d-recap-connemara", temps:7, dit:"joueuse", mots:["connemara","gris","liste","balzane","taille"],
        ...
        ar:"إذن: بوني كونيمارا أشهب، بغرة بيضاء عريضة، وعلامتين بيضاوين على القوائم، وارتفاعه نحو أربع عشرة يدا وبوصتين. هذا هو، صحيح؟" }
    ]
  }
};
