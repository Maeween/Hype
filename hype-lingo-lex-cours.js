...
window.HYPE_LINGO_LEX.cours = {
  ...
  { ref:"au-pas", lecon:1, coll:"allures",
    ...
    def:{ fr:"L'allure la plus lente, à quatre temps. « Walk on » veut dire « repartez au pas », pas simplement « pas ».",
          ...
          ar:"أبطأ مشيات الحصان، وهي مشية رباعية الإيقاع. ويعني الأمر الإنجليزي «ابدئي السير بالخطو»، لا مجرد كلمة «خطو»." } },
  ...
  { ref:"halte", lecon:1, coll:"allures",
    ...
    def:{ fr:"L'arrêt complet, immobile et droit. En anglais l'ordre est souvent précédé de « and », qui annonce la transition.",
          ...
          ar:"الوقوف التام، ساكنا ومستقيما." } },
  ...
  { ref:"au-trot", lecon:1, coll:"allures",
    ...
    def:{ fr:"Allure à deux temps, par bipèdes diagonaux.",
          ...
          ar:"مشية ثنائية الإيقاع تتحرك فيها القوائم في زوجين قطريين." } },
  ...
  { ref:"trot-enleve", lecon:1, coll:"allures",
    mots:{ fr:{m:"le trot enlevé", dit:"Trot enlevé !"},
           ...
           ar:{m:"الخبب الخفيف، مع النهوض والجلوس بالتناوب", dit:"خبب خفيف!"} },
    def:{ fr:"Le cavalier se lève un temps sur deux. C'est le mot qui change le plus d'un pays à l'autre : « rising » en Grande-Bretagne, « posting » aux États-Unis, et l'allemand dit littéralement « trot léger ».",
          ...
          ar:"ينهض الفارس مرة من كل مرتين. وهي الكلمة التي تتغير أكثر من غيرها من بلد إلى آخر." } },
  ...
  { ref:"trot-assis", lecon:1, coll:"allures",
    mots:{ fr:{m:"le trot assis", dit:"Trot assis !"},
           ...
           ar:{m:"الخبب جلوسا", dit:"خبب جلوسا!"} },
    def:{ fr:"Le cavalier reste assis et accompagne le mouvement du dos.",
          ...
          ar:"تبقين جالسة في السرج وترافقين حركة ظهر الحصان." } },
  ...
  { ref:"au-galop", lecon:1, coll:"allures",
    mots:{ fr:{m:"au galop", dit:"Au galop !"},
           ...
           ar:{m:"العدو الخفيف", dit:"إلى العدو الخفيف!"} },
    def:{ fr:"En anglais, le galop utilisé dans le travail courant est le **canter**. **Gallop** désigne un galop nettement plus rapide, notamment en extérieur ou en course. Dans un cours classique, si le moniteur demande de galoper, le mot attendu est généralement *canter*.",
          ...
          ar:"في الإنجليزية، العدو المستعمل في العمل اليومي كلمة، والعدو الأسرع بكثير كلمة أخرى لا تستعمل في الميدان." } },
  ...
  { ref:"transition", lecon:1, coll:"allures",
    mots:{ fr:{m:"la transition", dit:"Préparez la transition !"},
           ...
           ar:{m:"الانتقال بين المشيات", dit:"استعدوا للانتقال!"} },
    def:{ fr:"Le passage d'une allure à une autre. Une bonne transition doit être préparée, équilibrée et nette.",
          ...
          ar:"الانتقال من مشية إلى أخرى. يجب أن يكون الانتقال الجيد محضرا ومتوازنا وواضحا." } },
  ...
  { ref:"allongez", lecon:1, coll:"allures",
    mots:{ fr:{m:"allonger", dit:"Allongez !"},
           ...
           ar:{m:"إطالة الخطوة", dit:"أطيلوا الخطوة!"} },
    def:{ fr:"Agrandir la foulée sans accélérer le rythme.",
          ...
          ar:"زيادة طول الخطوة من دون تسريع الإيقاع." } },
  ...
  { ref:"raccourcissez", lecon:1, coll:"allures",
    mots:{ fr:{m:"raccourcir", dit:"Raccourcissez !"},
           ...
           ar:{m:"تقصير الخطوة", dit:"قصروا الخطوة!"} },
    def:{ fr:"Réduire la foulée en gardant l'énergie. Ne pas confondre avec ralentir.",
          ...
          ar:"تقليل طول الخطوة مع الحفاظ على النشاط. لا تخلطي بين ذلك وبين الإبطاء." } },
  ...
  { ref:"en-avant", lecon:1, coll:"allures",
    mots:{ fr:{m:"en avant", dit:"En avant !"},
           ...
           ar:{m:"التقدم بنشاط", dit:"إلى الأمام!"} },
    def:{ fr:"L'ordre le plus fréquent d'un cours : plus d'énergie, pas plus de vitesse.",
          ...
          ar:"أكثر الأوامر تكرارا في الدرس: مزيد من الطاقة، لا مزيد من السرعة." } },
  ...
  { ref:"talons-bas", lecon:2, coll:"position",
    mots:{ fr:{m:"les talons bas", dit:"Talons bas !"},
           ...
           ar:{m:"خفض الكعبين", dit:"اخفضوا الكعبين!"} },
    def:{ fr:"La correction la plus répétée au monde, dans toutes les langues.",
          ...
          ar:"أكثر التصحيحات تكرارا في العالم، وبكل اللغات." } },
  ...
  { ref:"regardez", lecon:2, coll:"position",
    mots:{ fr:{m:"regarder devant", dit:"Regardez devant vous !"},
           ...
           ar:{m:"النظر إلى الأمام", dit:"انظروا أمامكم!"} },
    def:{ fr:"Regarder où l'on va, jamais la tête du cheval. « Look up » ne veut pas dire lever les yeux au ciel.",
          ...
          ar:"انظري إلى حيث تذهبين، لا إلى رأس الحصان أبدا." } },
  ...
  { ref:"dos-droit", lecon:2, coll:"position",
    mots:{ fr:{m:"le dos droit", dit:"Redressez-vous !"},
           ...
           ar:{m:"استقامة الظهر", dit:"استقيموا!"} },
    def:{ fr:"Se grandir sans se raidir : le buste vertical, les épaules basses.",
          ...
          ar:"ارفعي قامتك من دون تصلب، مع إبقاء الجذع منتصبا والكتفين منخفضين." } },
  ...
  { ref:"epaules", lecon:2, coll:"position",
    mots:{ fr:{m:"les épaules en arrière", dit:"Les épaules en arrière !"},
           ...
           ar:{m:"إرجاع الكتفين", dit:"أرجعوا الكتفين!"} },
    def:{ fr:"Ouvrir la poitrine sans creuser les reins.",
          ...
          ja:"腰を反らせずに、胸を開くこと。",
          ar:"افتحي صدرك من دون المبالغة في تقويس أسفل الظهر." } },
  ...
  { ref:"raccourcir-renes", lecon:2, coll:"position",
    mots:{ fr:{m:"raccourcir ses rênes", dit:"Raccourcissez vos rênes !"},
           ...
           ar:{m:"تقصير الأعنة", dit:"قصروا أعنتكم!"} },
    def:{ fr:"Reprendre du contact. L'allemand dit « prendre les rênes », pas « les raccourcir ».",
          ...
          ar:"استعادة اتصال مرن بفم الحصان. والألمانية تقول «خذي الأعنة»، لا «اقصريها»." } },
  ...
  { ref:"renes-longues", lecon:2, coll:"position",
    mots:{ fr:{m:"les rênes longues", dit:"Rendez les rênes !"},
           ...
           ar:{m:"إرخاء الأعنة", dit:"أرخوا الأعنة!"} },
    def:{ fr:"Laisser davantage de longueur de rênes pour permettre au cheval de s'étendre, notamment pendant une récupération ou en fin de séance. En anglais, *free walk on a long rein* désigne aussi un mouvement précis de dressage.",
          ...
          ar:"اتركي مزيدا من طول الأعنة حتى يتمكن الحصان من مد عنقه، خصوصا أثناء استعادة الأنفاس أو في نهاية الحصة." } },
  ...
  { ref:"jambes", lecon:2, coll:"position",
    mots:{ fr:{m:"les jambes", dit:"Plus de jambes !"},
           ...
           ar:{m:"استخدام الساقين", dit:"استعملوا الساقين!"} },
    def:{ fr:"L'aide qui pousse. Attention : en anglais et en allemand, l'ordre est au singulier — « more leg », « mehr Schenkel ».",
          ...
          ar:"العون الذي يدفع. انتبهي: في الإنجليزية والألمانية يأتي الأمر بصيغة المفرد." } },
  ...
  { ref:"assiette", lecon:2, coll:"position",
    mots:{ fr:{m:"l'assiette", dit:"Asseyez-vous dans la selle !"},
           ...
           ar:{m:"الجلوس في السرج", dit:"اجلسوا بعمق في السرج!"} },
    def:{ fr:"La façon dont le cavalier est assis, et l'aide qu'il en tire.",
          ...
          ar:"طريقة جلوسك في السرج وكيفية استخدام وزنك وحركة حوضك للتواصل مع الحصان." } },
  ...
  { ref:"monter", lecon:2, coll:"position", v:true,
    ...
    def:{ fr:"Se mettre en selle, traditionnellement du côté gauche.",
          ...
          ar:"الصعود إلى السرج، ويتم ذلك تقليديا من الجهة اليسرى." } },
  ...
  { ref:"descendre", lecon:2, coll:"position", v:true,
    mots:{ fr:{m:"mettre pied à terre", dit:"Pied à terre !"},
           ...
           ar:{m:"النزول عن الحصان", dit:"انزلوا!"} },
  ...
  { ref:"main-gauche", lecon:3, coll:"figures",
    mots:{ fr:{m:"sur la main gauche", dit:"Sur la main gauche !"},
           ...
           ar:{m:"السير على اليد اليسرى", dit:"على اليد اليسرى!"} },
    def:{ fr:"On tourne à gauche : la main gauche est vers l'intérieur, et le mur est donc à ta droite. ⚠️ L'anglais dit « rein », la rêne — pas « hand ». C'est l'un des ordres les plus mal compris par un francophone.",
          en:"Going left: your left hand is to the inside, so the wall is on your right. Note that English uses « rein » where French says « hand ».",
          es:"Se gira a la izquierda: la mano izquierda queda hacia dentro, así que la pared queda a tu derecha. ⚠️ El inglés dice « rein », la rienda — no « hand ». Es una de las órdenes peor entendidas por un francófono.",
          it:"Si gira a sinistra: la mano sinistra è verso l'interno, quindi il muro è alla tua destra. ⚠️ L'inglese dice « rein », la redine — non « hand ». È uno degli ordini più fraintesi da un francofono.",
          de:"Man wendet nach links: die linke Hand zeigt nach innen, die Bande ist also rechts. ⚠️ Das Englische sagt « rein », der Zügel — nicht « hand ». Einer der meistmissverstandenen Befehle.",
          ja:"左へ回ります。左手が内側になるので、壁は右側です。⚠️ 英語は « hand » ではなく « rein »（手綱）と言います。フランス語話者が最も聞き違える号令のひとつです。",
          ar:"تسيرين في الاتجاه الذي تكون فيه يدك اليسرى نحو داخل الميدان، ويكون الجدار عادة إلى يمينك عندما تسيرين على المسار الخارجي. والإنجليزية تقول «العنان» لا «اليد»." } },
  ...
  { ref:"main-droite", lecon:3, coll:"figures",
    mots:{ fr:{m:"sur la main droite", dit:"Sur la main droite !"},
           ...
           ar:{m:"السير على اليد اليمنى", dit:"على اليد اليمنى!"} },
    def:{ fr:"On tourne à droite : la main droite est vers l'intérieur, et le mur est donc à ta gauche.",
          en:"Going right: your right hand is to the inside, so the wall is on your left.",
          es:"Se gira a la derecha: la mano derecha queda hacia dentro, así que la pared queda a tu izquierda.",
          it:"Si gira a destra: la mano destra è verso l'interno, quindi il muro è alla tua sinistra.",
          de:"Man wendet nach rechts: die rechte Hand zeigt nach innen, die Bande ist also links.",
          ja:"右へ回ります。右手が内側になるので、壁は左側です。",
          ar:"تسيرين في الاتجاه الذي تكون فيه يدك اليمنى نحو داخل الميدان، ويكون الجدار عادة إلى يسارك عندما تسيرين على المسار الخارجي." } },
  ...
  { ref:"changer-main", lecon:3, coll:"figures",
    mots:{ fr:{m:"changer de main", dit:"Changez de main !"},
           ...
           ar:{m:"تغيير الاتجاه (تغيير اليد)", dit:"غيروا الاتجاه!"} },
    def:{ fr:"Passer d'un sens à l'autre, en général par la diagonale.",
          ...
          ar:"الانتقال من اتجاه إلى آخر، عبر القطر في الغالب." } },
  ...
  { ref:"piste", lecon:3, coll:"figures",
    mots:{ fr:{m:"la piste", dit:"Sur la piste !"},
           ...
           ar:{m:"المسار الخارجي", dit:"عودوا إلى المسار!"} },
    def:{ fr:"Le tour extérieur du manège. ⚠️ L'ordre anglais est **« go large »**, qui ne se devine pas du tout — il veut dire « reprenez la piste ».",
          ...
          ar:"المسار الخارجي للميدان. والأمر الإنجليزي لا يمكن تخمينه إطلاقا: معناه «عودي إلى المسار الخارجي»." } },
  ...
  { ref:"diagonale", lecon:3, coll:"figures",
    ...
    def:{ fr:"La ligne qui traverse le manège d'un coin à l'autre, servant au changement de main.",
          ...
          ar:"خط يقطع الميدان من زاوية إلى الزاوية المقابلة، ويستخدم غالبا لتغيير الاتجاه." } },
  ...
  { ref:"cercle", lecon:3, coll:"figures",
    mots:{ fr:{m:"le cercle", dit:"Un cercle de vingt mètres !"},
           ...
           ar:{m:"الدائرة", dit:"دائرة قطرها عشرون مترا!"} },
    def:{ fr:"La figure de base du travail sur le plat. L'allemand a un mot dédié, « Zirkel », qui désigne précisément le cercle de vingt mètres.",
          ...
          ar:"الشكل الأساسي في العمل على المسطح. وللألمانية كلمة خاصة تدل تحديدا على دائرة العشرين مترا." } },
  ...
  { ref:"volte", lecon:3, coll:"figures",
    mots:{ fr:{m:"la volte", dit:"Une volte !"},
           ...
           ar:{m:"الدائرة الصغيرة", dit:"دائرة صغيرة!"} },
    def:{ fr:"Un petit cercle, de six à dix mètres.",
          ...
          ja:"直径六〜十メートルの小さな円。",
          ar:"دائرة صغيرة، من ستة إلى عشرة أمتار." } },
  ...
  { ref:"serpentine", lecon:3, coll:"figures",
    mots:{ fr:{m:"la serpentine", dit:"Une serpentine !"},
           ...
           ar:{m:"المسار المتعرج (الثعبانية)", dit:"مسار متعرج!"} },
    def:{ fr:"Une suite de boucles d'un long côté à l'autre.",
          ...
          ar:"سلسلة من الأقواس المتتابعة تمتد من أحد الضلعين الطويلين إلى الآخر." } },
  ...
  { ref:"coin", lecon:3, coll:"figures",
    mots:{ fr:{m:"le coin", dit:"Servez-vous de vos coins !"},
           ...
           ar:{m:"الزاوية", dit:"استفيدوا من الزوايا!"} },
    def:{ fr:"Les quatre angles du manège. Les « faire » vraiment est la marque d'une reprise soignée.",
          ...
          ar:"زوايا الميدان الأربع. وأداؤها فعلا علامة على حصة متقنة." } },
  ...
  { ref:"ligne-milieu", lecon:3, coll:"figures",
    mots:{ fr:{m:"la ligne du milieu", dit:"Doublez dans la longueur !"},
           ...
           ar:{m:"الخط الأوسط", dit:"إلى الخط الأوسط!"} },
    def:{ fr:"La ligne qui coupe le manège en deux dans la longueur, de A à C.",
          ...
          ja:"馬場を縦に二分する線。AからCへ。",
          ar:"الخط الذي يقسم الميدان طولا إلى نصفين، من ألف إلى سين." } },
  ...
  { ref:"detente", lecon:4, coll:"deroule",
    mots:{ fr:{m:"la détente", dit:"On se détend au pas !"},
           ...
           ar:{m:"الإحماء", dit:"ابدؤوا الإحماء بالخطو!"} },
    def:{ fr:"Le début de séance, rênes longues, pour échauffer le cheval.",
          ...
          ar:"بداية الحصة، بأعنة طويلة، لإحماء الحصان." } },
  ...
  { ref:"recuperation", lecon:4, coll:"deroule",
    mots:{ fr:{m:"la récupération", dit:"On récupère au pas !"},
           ...
           ar:{m:"التهدئة واستعادة الأنفاس", dit:"عودوا إلى الخطو لاستعادة الأنفاس!"} },
    def:{ fr:"La fin de séance, au pas, rênes longues, jusqu'à ce que la respiration et le rythme cardiaque du cheval reviennent vers la normale.",
          en:"The end of a session, in walk on a long rein, until the horse's breathing and heart rate come back towards normal.",
          es:"El final de la sesión, al paso y con riendas largas, hasta que la respiración y el ritmo cardíaco del caballo vuelvan hacia la normalidad.",
          it:"La fine della seduta, al passo con redini lunghe, finché respiro e battito del cavallo non tornano verso la norma.",
          de:"Das Ende der Einheit, im Schritt am langen Zügel, bis Atmung und Herzschlag des Pferdes sich wieder normalisieren.",
          ja:"練習の終わり。手綱を伸ばした常歩で、馬の呼吸と心拍が落ち着くまで歩かせます。",
          ar:"فترة من السير بالخطو مع إرخاء الأعنة، حتى يعود تنفس الحصان ونبضه تدريجيا نحو المعدل الطبيعي." } },
  ...
  { ref:"toute-reprise", lecon:4, coll:"deroule",
    mots:{ fr:{m:"toute la reprise", dit:"Toute la reprise, au trot !"},
           ...
           ar:{m:"المجموعة كلها", dit:"المجموعة كلها، إلى الخبب!"} },
    def:{ fr:"Tous les cavaliers ensemble. ⚠️ En anglais, « the ride » désigne le **groupe d'élèves**, pas la promenade — un faux ami redoutable.",
          ...
          ar:"جميع الفرسان معا. وفي الإنجليزية، الكلمة تدل على مجموعة التلاميذ لا على النزهة: فخ خطير." } },
  ...
  { ref:"file-indienne", lecon:4, coll:"deroule",
    mots:{ fr:{m:"en file indienne", dit:"En file indienne !"},
           ...
           ar:{m:"في صف واحد", dit:"في صف واحد!"} },
    def:{ fr:"Les uns derrière les autres, avec la distance d'un cheval.",
          ...
          ar:"يسير الفرسان الواحد خلف الآخر، مع ترك مسافة آمنة لا تقل عادة عن طول حصان." } },
  ...
  { ref:"distance", lecon:4, coll:"deroule",
    mots:{ fr:{m:"la distance", dit:"Gardez vos distances !"},
           ...
           ar:{m:"المسافة", dit:"حافظوا على المسافة!"} },
    def:{ fr:"L'espace entre deux chevaux : une longueur de cheval au minimum.",
          ...
          ja:"前の馬との間隔。最低でも馬一頭分。",
          ar:"المسافة بين حصانين: طول حصان على الأقل." } },
  ...
  { ref:"preparez", lecon:4, coll:"deroule",
    ...
    def:{ fr:"L'annonce qui précède l'ordre. En reprise, elle donne une ou deux foulées pour se placer.",
          ...
          ar:"الإعلان الذي يسبق الأمر. وفي الحصة، يمنحك خطوة أو خطوتين لتتهيئي." } },
  ...
  { ref:"reprenez", lecon:4, coll:"deroule",
    mots:{ fr:{m:"reprendre", dit:"Reprenez !"},
           ...
           ar:{m:"استئناف التمرين", dit:"تابعوا!"} },
    def:{ fr:"Continuer ce qu'on faisait, après une pause ou une correction.",
          ...
          ar:"مواصلة ما كنت تفعلينه، بعد استراحة أو تصحيح." } },
  ...
  { ref:"doucement", lecon:4, coll:"deroule",
    ...
    def:{ fr:"Calmer sans arrêter. « Steady » est l'un des mots les plus employés d'un manège anglais.",
          ...
          ar:"التهدئة من دون التوقف. وهي من أكثر الكلمات استعمالا في ميدان إنجليزي." } },
  ...
  { ref:"pause", lecon:4, coll:"deroule",
    ...
    def:{ fr:"Un temps de marche au pas, rênes longues, au milieu du cours.",
          ...
          ar:"وقت من المشي على مشية الخطو، بأعنة طويلة، في وسط الدرس." } },
  ...
  { ref:"au-centre", lecon:4, coll:"deroule",
    mots:{ fr:{m:"au centre", dit:"Rassemblez-vous au centre !"},
           ...
           ar:{m:"إلى الوسط", dit:"اجتمعوا في الوسط!"} },
    def:{ fr:"L'ordre de fin de cours, ou celui qui précède une explication.",
          ...
          ar:"أمر نهاية الدرس، أو الذي يسبق شرحا." } },
  ...
  { ref:"bien", lecon:4, coll:"deroule",
    mots:{ fr:{m:"bien", dit:"Bien ! C'est ça !"},
           ...
           ar:{m:"أحسنت", dit:"أحسنتم! هكذا تماما!"} },
    def:{ fr:"L'encouragement. Le connaître évite de croire qu'on s'est trompé.",
          ...
          ar:"التشجيع. ومعرفته تجنبك أن تظني أنك أخطأت." } },
  ...
  { ref:"attention", lecon:4, coll:"deroule",
    ...
    def:{ fr:"Le mot qu'il faut comprendre en un dixième de seconde. À apprendre avant tous les autres.",
          ...
          ar:"الكلمة التي يجب فهمها في جزء من الثانية، ولذلك ينبغي تعلمها قبل جميع الأوامر الأخرى." } }
  ],
  ...
  phrases: [
    ...
    { ref:"main-gauche-piste", lecon:3,
      ...
      ja:"左 手前 で 蹄跡 を 進ん で。",
      ar:"على اليد اليسرى، عودي إلى المسار." },
    { ref:"prepare-galop", lecon:4,
      ...
      ja:"隅 で 駈歩 発進。",
      ar:"استعدي للانطلاق إلى العدو الخفيف في الزاوية." },
  ...
  ================================================================== */
  dialogue: {
    ville: "aberystwyth", lecon: 1, temps: 6, langues: ["fr","en","es","it","de","ja","ar"],   /* 24 phrases */
    ...
    phrases: [
      ...
      ar:"هل يمكنك إمساك الحصان من أجلي؟" },
      ...
      ar:"انتبهي إلى إعادة شد حزام السرج." },
      ...
      ar:"قصري سيور الركابين، فسوف نقفز." },
      ...
      ar:"اليوم سنتدرب على الترويض، ويمكنك إطالة سيور الركابين بمقدار ثقبين." },
      ...
      ar:"حافظوا على المسافات، في صف واحد." },
      ...
      ar:"حافظي على استقامة ظهرك وارفعي قامتك." },
      ...
      { ref:"d-r-mains-basses", temps:2, dit:"club", mots:[],
        ...
        ja:"手 は 低く、 動かさ ない で。",
      ar:"أبقي يديك منخفضتين ومستقرتين." },
      ...
      ar:"عذرا، لم أفهم. هل يمكنك إعادة ذلك ببطء أكثر؟" },
      ...
      ar:"نفذي دائرة صغيرة عند الحرف ألف، ثم عودي إلى المسار." },
      ...
      ar:"ابدئي بتحضير مساعداتك للانطلاق إلى العدو الخفيف." },
      ...
      ar:"اثني مرفقيك ومديهما بمرونة لمتابعة حركة الحصان في العدو." },
      ...
      ar:"أفضل ألا أنتقل إلى العدو اليوم." },
      ...
      ar:"هل يمكنني التمهل أو العودة إلى الخطو؟" },
      ...
      ar:"أرخي الأعنة ودعي الخيول تستعيد أنفاسها." },
