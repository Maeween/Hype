/* hype-lingo-lex-arrivee.js — Hype Linguae · l'arrivée dans un club
   ...
   sécurité, sans retaguer une troisième fois.
      🟡 CHAMP `ar` — ARABE DORMANT (23/08/2026).
   Chaque concept, chaque réplique et chaque phrase porte un champ `ar`.
   AUCUN ÉCRAN NE LE LIT : le sélecteur reste à six langues. Même
   dispositif qu'à Clonbinane et Spruce Meadows. Voir SUIVI-ARABE.md.

   🟥 CHAPITRE DE SÉCURITÉ — LE PLUS SENSIBLE DE L'APP.
   « lâche ! », « ne passe pas derrière lui », « ne bouge pas », « tiens-le ».
   Ici une traduction fausse ne fait pas qu'un contresens : elle peut
   blesser quelqu'un. Les ordres ont donc été rendus COURTS et DIRECTS,
   sans tournure élégante : اترك الحبل! · لا تمر من خلفه · لا تتحرك.
   Ne pas les allonger ni les adoucir en relecture.

   ⚠️ LES FAUX AMIS DU CHAPITRE N'EXISTENT PAS EN ARABE. Les définitions
   françaises expliquent canter/gallop, hat/helmet, hack/trail ride,
   nice/kind/genuine, fast/forward — ce sont des pièges de l'ANGLAIS.
   En arabe j'ai gardé le SENS (le galop tranquille, le cheval qui
   avance de lui-même, le cheval honnête) sans transposer le piège, qui
   n'aurait rien voulu dire. `cheval-rapide` et `cheval-sympa` portent
   une `var` arabe : حصان نشط من تلقاء نفسه et حصان صادق.

   ⚠️ `niveau` — la mention du Galop français a été retirée de l'arabe :
   la définition dit simplement que les échelles ne se traduisent pas.

   ✅ PREMIÈRE RELECTURE CROISÉE, 23/08. Deux corrections structurelles :

   🟥 1. TOUT L'ARABE EST AU FÉMININ. L'arabe n'a pas d'impératif neutre :
   اتركي s'adresse à une femme, اترك à un homme. Le français « lâche ! »
   vaut pour tous, l'arabe doit choisir. Les onze ordres de sécurité et
   toutes les définitions ont donc été accordés au féminin.
   ⚠️ CONSÉQUENCE ASSUMÉE : un cavalier lira des consignes adressées à une
   cavalière. Signalé à Blandine le 23/08. Alternatives si on revient
   dessus : masculin (qui inclut conventionnellement les deux en arabe
   standard) ou double forme. Une passe suffit à basculer.

   2. LE GALOP. الركض (courir, générique) remplacé partout par
   العدو الخفيف — le galop contrôlé de tous les jours — par opposition à
   العدو السريع, le galop de course. C'est la distinction canter/gallop,
   qui existe donc bien en arabe.

   Plus : حصان ذو اندفاع طبيعي pour « forward horse » ;
   حصان موثوق وطيب الطباع pour « genuine » (حصان صادق est un usage de
   professionnels, moins transparent pour une débutante) ;
   حبل القيادة partout pour la longe ; أحذية مغلقة au pluriel.

   ✅ LES ONZE ORDRES DE SÉCURITÉ SONT VALIDÉS un par un par la relecture,
   avec mention expresse de garder الحبل dans « اتركي الحبل! » pour lever
   toute ambiguïté sur ce qu'on lâche. NE PAS LES RACCOURCIR DAVANTAGE.
...
window.HYPE_LINGO_LEX.arrivee = {
  ...
  { ref:"reserver", lecon:1, coll:"inscrire",
    ...
    def:{ fr:"Retenir une place à l'avance. Dans la plupart des clubs c'est indispensable la veille, et parfois plusieurs jours avant en saison.",
          ...
          ar:"حجز مكان مسبقا. في معظم النوادي يكون ذلك ضروريا قبل يوم، وأحيانا قبل عدة أيام في الموسم." } },
  ...
  { ref:"niveau", lecon:1, coll:"inscrire",
    ...
    def:{ fr:"Ce qu'on sait faire. ⚠️ Les échelles ne se traduisent pas : un Galop 4 français ne veut rien dire ailleurs. Dis ce que tu sais faire — trotter, galoper, sauter — pas ton diplôme.",
          ...
          ar:"ما تستطيعين القيام به. لا يمكن نقل درجات التصنيف من بلد إلى آخر، لذلك اذكري ما تتقنينه فعلا: مشية الخطو، والخبب، والعدو الخفيف، والقفز، بدلا من الاكتفاء باسم شهادتك." } },
  ...
  { ref:"debutant", lecon:1, coll:"inscrire",
    ...
    def:{ fr:"Le mot le plus utile du chapitre. Le dire coûte un peu d'orgueil et évite beaucoup d'ennuis : personne ne juge un débutant, tout le monde juge un débutant qui s'était annoncé cavalier.",
          ...
          ar:"أنفع كلمة في هذا الفصل. قد يتطلب قولها بعض التواضع، لكنه يجنبك متاعب كثيرة. لا أحد يلوم مبتدئة، لكن الجميع يلوم من تقدم نفسها كفارسة متمرسة وهي ليست كذلك." } },
  ...
  { ref:"tarif", lecon:1, coll:"inscrire",
    ...
    def:{ fr:"Le prix de la reprise. Demande s'il comprend l'assurance et le matériel : selon les pays, l'un ou l'autre se paie à part.",
          ...
          ar:"ثمن الدرس. اسألي إن كان يشمل التأمين والمعدات: ففي بعض البلدان يدفع أحدهما أو كلاهما على حدة." } },
  ...
  { ref:"licence-assurance", lecon:3, coll:"inscrire",
    ...
    def:{ fr:"Obligatoire pour monter dans presque tous les pays. Ta licence fédérale ne te couvre pas forcément à l'étranger : vérifie avant de partir, pas au moment de monter.",
          ...
          ar:"إلزامي للركوب في معظم البلدان تقريبا. رخصتك في بلدك قد لا تغطيك في الخارج: تحققي قبل السفر، لا لحظة الركوب." } },
  ...
  { ref:"bombe-fournie", lecon:1, coll:"inscrire",
    ...
    def:{ fr:"Presque toujours vrai, mais à demander : c'est la seule pièce d'équipement sans laquelle on ne monte pas. En Grande-Bretagne on dit « hat », pas « helmet », dans un club.",
          ...
          ar:"صحيح في الغالب، لكن يجب السؤال: فهي قطعة المعدات الوحيدة التي لا يركب أحد بدونها." } },
  ...
  { ref:"balade", lecon:1, coll:"inscrire",
    ...
    def:{ fr:"Une sortie dehors, par opposition à la reprise en carrière — à la plage ou en montagne selon le centre. ⚠️ « Hack » est le mot britannique ; les Américains disent « trail ride ».",
          ...
          ar:"خروج إلى الطبيعة، بخلاف الدرس في الميدان — إلى الشاطئ أو الجبل حسب المركز." } },
  ...
  { ref:"le-groupe", lecon:1, coll:"inscrire",
    ...
    def:{ fr:"Utile dès qu'on n'est pas seul : précise combien de cavaliers, et combien sont débutants — le club adapte le nombre de chevaux calmes en conséquence.",
          ...
          ar:"يفيدك هذا التعبير عندما لا تكونين وحدك. حددي عدد الفرسان وعدد المبتدئين منهم، ليتمكن النادي من توفير العدد المناسب من الخيول الهادئة." } },
  ...
  { ref:"pas", lecon:1, coll:"inscrire",
    ...
    def:{ fr:"La plus lente des trois allures, celle où l'on part et où l'on rentre presque toujours. C'est aussi le mot qu'on utilise pour calmer : « au pas » se dit à un cheval qui s'excite.",
          ...
          ar:"أبطأ المشيات الثلاث، وهي التي ننطلق بها ونعود بها في الغالب. وهي أيضا الكلمة التي تستعمل للتهدئة: تقال للحصان حين يتحمس." } },
  ...
  { ref:"passer-devant", lecon:2, coll:"securite",
    ...
    def:{ fr:"La règle la plus simple et la plus utile : on contourne un cheval par l'avant, où il te voit. Derrière, il ne te voit pas, et un cheval qui sursaute frappe.",
          ...
          ar:"أبسط القواعد وأنفعها: نمر حول الحصان من الأمام، حيث يراك. أما من الخلف فهو لا يراك، والحصان الذي يفزع يرفس." } },
  ...
  { ref:"jamais-derriere", lecon:2, coll:"securite",
    ...
    def:{ fr:"La phrase qu'on entend crier dans tous les clubs du monde. Si tu dois vraiment passer derrière, passe très près en gardant une main sur lui : un cheval frappe avec de l'élan, pas collé.",
          ...
          ar:"هذه عبارة تسمعينها في جميع نوادي الفروسية. وإذا اضطررت فعلا إلى المرور خلف الحصان، فمري بالقرب منه مع إبقاء يدك على جسمه حتى يشعر بوجودك." } },
  ...
  { ref:"prevenir-toucher", lecon:2, coll:"securite",
    ...
    def:{ fr:"La voix d'abord, la main ensuite. Un cheval surpris se défend ; un cheval averti attend.",
          ...
          ar:"استخدمي صوتك أولا، ثم ضعي يدك عليه. فالحصان الذي يفاجأ قد يدافع عن نفسه، أما الحصان الذي نبه إلى وجودك فيبقى مستعدا." } },
  ...
  { ref:"longe-main", lecon:2, coll:"securite",
    ...
    def:{ fr:"Le geste qui casse des doigts. On tient la longe pliée dans la main, jamais enroulée autour : si le cheval part, la corde doit pouvoir filer.",
          ...
          ar:"هذه الحركة قد تكسر الأصابع. أمسكي الحبل مطويا في يدك، ولا تلفيه حولها أبدا. فإذا انطلق الحصان فجأة، يجب أن يتمكن الحبل من الانفلات بحرية." } },
  ...
  { ref:"distance", lecon:2, coll:"securite",
    ...
    def:{ fr:"En reprise, une longueur de cheval entre le tien et celui de devant. C'est la distance qui évite un coup de pied — et le plus fréquent des accidents de club.",
          ...
          ar:"اتركي في الدرس مسافة تعادل طول حصان بين حصانك والحصان الذي أمامك. فهذه المسافة تساعد على تجنب الرفسات، وهي من أكثر الحوادث شيوعا في نوادي الفروسية." } },
  ...
  { ref:"tenir-cheval", lecon:2, coll:"securite",
    ...
    def:{ fr:"On te le demandera, et il faut comprendre du premier coup : tenir la longe court, sous la ganache, et rester debout à côté de l'épaule.",
          ...
          ar:"قد يطلب منك ذلك، ويجب أن تفهميه فورا: أمسكي حبل القيادة قصيرا تحت فك الحصان، وقفي إلى جانب كتفه." } },
  ...
  { ref:"lacher", lecon:2, coll:"securite",
    ...
    def:{ fr:"L'ordre le plus contre-intuitif du chapitre, et celui qui sauve des mains. Si le cheval s'arrache, on lâche : on ne discute pas avec cinq cents kilos.",
          ...
          ar:"هذا أكثر أوامر الفصل مخالفة للحدس، لكنه يحمي اليدين. إذا أفلت الحصان بعنف، فاتركي الحبل فورا. لا تحاولي مقاومة حصان يزن خمسمئة كيلوغرام." } },
  ...
  { ref:"casque-attache", lecon:2, coll:"securite",
    ...
    def:{ fr:"Une bombe non attachée ne protège de rien. On te le fera remarquer dans tous les pays, et souvent avant de te laisser monter.",
          ...
          ar:"خوذة غير مربوطة لا تحمي من شيء. سينبهك أحدهم إلى ذلك في كل البلدان، وغالبا قبل أن يسمح لك بالركوب." } },
  ...
  { ref:"chaussures-fermees", lecon:2, coll:"securite",
    ...
    def:{ fr:"Pas de sandales dans une écurie, jamais. Un sabot de cheval pèse le poids du cheval au-dessus.",
          ...
          ar:"لا صنادل في الإسطبل، أبدا. فحافر الحصان يحمل ثقل الحصان كله فوقه." } },
  ...
  { ref:"chute-bouge-pas", lecon:2, coll:"securite",
    ...
    def:{ fr:"Ce qu'on dit à un cavalier tombé, et ce qu'on doit comprendre si on tombe. On ne relève pas quelqu'un : on lui demande s'il va bien, et on attrape le cheval.",
          ...
          ar:"يقال هذا الأمر لفارسة سقطت، ويجب أن تفهميه فورا إذا سقطت. لا نحاول رفع المصابة مباشرة، بل نسألها إن كانت بخير ونمسك الحصان." } },
  ...
  { ref:"cavalier-confirme", lecon:1, coll:"inscrire",
    ...
    def:{
      ...
      ja:"すでに乗れる人。初心者の反対です。⚠️ 英語で « confirmed rider » とは言いません。クラブはこの線でレッスンを分けるので、自分がどちら側かを言えると役に立ちます。この言葉はル・モルヌでまた出てきて、そこではラグーンを開く鍵になります。",
          ar:"هي التي تجيد الركوب بالفعل، بخلاف المبتدئة. يصنف النادي دروسه على هذا الأساس، لذلك من الأفضل أن تحددي بصدق الفئة التي تناسب مستواك." } },
  ...
  { ref:"cheval-rapide", lecon:1, coll:"inscrire",
    mots:{ fr:{m:"un cheval rapide"},
           ...
           ar:{m:"حصان سريع", var:"حصان ذو اندفاع طبيعي"} },
    def:{
      ...
      ja:"おとなしい馬の反対で、すでに乗れる人向けです。⚠️ « fast » はどこでも通じますが、馬房では « forward » と言うことが多い — 押さなくても自分から前に出る馬のことです。暴走する馬ではなく、前進気勢のある馬です。",
          ar:"هو عكس الحصان الهادئ جدا، ويطلب عادة لمن تجيد الركوب. المقصود حصان يتقدم من تلقاء نفسه ويتمتع باندفاع طبيعي، من دون الحاجة إلى دفعه باستمرار. ولا يعني ذلك أنه يجمح أو ينطلق بسرعة خارج السيطرة." } },
  ...
  { ref:"cheval-sympa", lecon:1, coll:"inscrire",
    mots:{ fr:{m:"un cheval sympa"},
           ...
           ar:{m:"حصان لطيف", var:"حصان موثوق وطيب الطباع"} },
    def:{
      ...
      ja:"あまり自信がないときに頼む馬です。⚠️ « a nice horse » とも言いますが、馬の英語でいちばん曖昧な言い方です — 性格がいい、とも、血統がいい、とも取れます。« a kind horse » のほうが確実で、いちばん確実なのは « a genuine horse » — 絶対に驚かせない、正直な馬という意味です。",
          ar:"هو الحصان الذي تطلبينه عندما لا تكونين مطمئنة تماما. والأدق أن تطلبي حصانا طيب الطباع وموثوقا، أي حصانا لا يفاجئ فارسته بردود فعل غير متوقعة." } }
  ...
  { ref:"ph-derriere", lecon:2, mots:["jamais-derriere", "passer-devant"],
      ...
      ar:"لا تمري من خلفه، بل مري من أمامه." },
  ...
  { ref:"ph-longe", lecon:2, mots:["longe-main"],
      ...
      ar:"لا تلفي حبل القيادة حول يدك أبدا." },
  ...
  { ref:"ph-lb-pourra-trotter", lecon:1, mots:["trot"],
      ...
      ja:"速歩 も でき ます か。",
      ar:"هل يمكننا الانتقال إلى الخبب؟" },
  { ref:"ph-lb-galop-confirmes", lecon:1, mots:["galop", "cavalier-confirme"],
      ...
      ja:"駈歩 は 経験者 だけ です。",
      ar:"العدو الخفيف مخصص للفارسات المتمرسات." },
  { ref:"ph-lb-porter-bottes", lecon:1, mots:["bottes"],
      ...
      ar:"هل علي أن أرتدي أحذية ركوب طويلة؟" },
  ...
  { ref:"ph-lb-garde-distances", lecon:2, mots:["distance"],
      ...
      ar:"حافظي على مسافة آمنة بينك وبين الخيول الأخرى." },
  ...
  { ref:"ph-lb-tiens-le-cheval", lecon:2, mots:["tenir-cheval"],
      ...
      ar:"أمسكي الحصان بينما أفتح الباب." },
  ...
  { ref:"ph-lb-attache-ta-bombe", lecon:2, mots:["casque-attache"],
      ...
      ar:"اربطي خوذتك جيدا قبل أن تركبي." },
  ...
  ================================================================== */
  dialogue: {
    ville: "labaule", lecon: 1, temps: 6, langues: ["fr","en","es","it","de","ja","ar"],   /* 25 phrases depuis le 13/08 */
    ...
    phrases: [
      ...
      ar:"مرحبا، أود بعض المعلومات عن مركزكم للفروسية." },
  ...
  { ref:"d-quel-niveau-requis", temps:2, dit:"joueuse", mots:["niveau"],
      ...
      ar:"ما المستوى المطلوب للمشاركة في هذا الدرس؟" },
      ...
      ar:"أود التسجيل في درس صباح الغد." },
      ...
      ar:"هل يمكنني حجز حصة واحدة فقط؟" },
      ...
      ar:"هل يمكنكم أن تقترحوا علي حصانا هادئا لكن فيه بعض النشاط؟" },
      ...
      ar:"أفضل أن أركب حصانا طويل القامة نوعا ما." },
      ...
      ar:"أي حصان ستخصصون لي في الدرس؟" },
      ...
      ar:"ليس لدي خوذة بعد — هل تعيرون خوذات؟" },
      ...
      ar:"في أي ساعة يجب أن أصل لأجهز الحصان؟" },
      ...
      ar:"هل علي أن أسرج الحصان بنفسي؟" },
      ...
      ar:"أين أجد غرفة السروج وأدوات العناية بالحصان؟" },
      ...
      ar:"هل يمكننا الانتقال إلى العدو الخفيف من دون الإسراع؟" },
      ...
      ar:"لا أشعر بالاطمئنان التام أثناء الركوب. هل لديكم حصان هادئ وطيب الطباع؟" },
      ...
      ar:"أعجبني الدرس كثيرا. هل يمكنني حجز حصة أخرى هذا الأسبوع؟" },
