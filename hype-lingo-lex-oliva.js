...
window.HYPE_LINGO_LEX.oliva = {
  ...
  { ref:"engagement", lecon:1, coll:"engager",
    mots:{ fr:{m:"l'engagement"}, en:{m:"the entry", p:"èn-tri"},
           ...
           ar:{m:"التسجيل"} }, // ??
    def:{ fr:"L'inscription à une épreuve, avec sa date de clôture. À l'étranger, c'est là qu'on découvre les exigences réelles : licence valide, enregistrement du cavalier et du cheval, passeport à jour, règles de la fédération concernée — à vérifier des semaines avant, pas la veille.",
          en:"Entering a class, with its closing date. Abroad this is where you discover the real requirements: a valid licence, rider and horse registration, an up-to-date passport, the rules of the federation concerned.",
          es:"La inscripción a una prueba, con su fecha de cierre. En el extranjero es ahí donde se descubren las exigencias reales: licencia válida, registro del jinete y del caballo, pasaporte al día, reglas de la federación correspondiente — a verificar semanas antes, no la víspera.",
          it:"L'iscrizione a una prova, con la sua data di chiusura. All'estero è lì che si scoprono le esigenze reali: licenza valida, registrazione di cavaliere e cavallo, passaporto aggiornato, regole della federazione competente — da verificare settimane prima, non la vigilia.",
          de:"Die Nennung zu einer Prüfung, mit Nennschluss. Im Ausland zeigt sich hier, was wirklich verlangt wird: gültige Lizenz, Registrierung von Reiter und Pferd, aktueller Pass, Regeln des zuständigen Verbands — Wochen vorher prüfen, nicht am Vorabend.",
          ja:"競技へのエントリー。締切日があります。海外では、本当に必要なものがここで分かります。有効なライセンス、騎手と馬の登録、最新のパスポート、主催連盟の規則 — 確認は数週間前に。前日ではなく。",
  ...
  { ref:"commissaire", lecon:1, coll:"engager",
    mots:{ fr:{m:"le commissaire"}, en:{m:"the steward", p:"stiou-eurd"},
           ...
           ar:{m:"المشرف (Steward)"} }, // ??
    def:{ fr:"Il surveille la détente, contrôle les embouchures et fait respecter la sécurité. ⚠️ Le mot anglais **steward** n'a rien à voir avec l'aviation : c'est lui qu'on trouve à la détente ; s'il constate un problème, il intervient et saisit le jury, qui décide.",
          en:"They supervise the warm-up, check tack and enforce safety. « Steward » here has nothing to do with aircraft.",
          es:"Vigila el calentamiento, controla las embocaduras y hace respetar la seguridad. ⚠️ La palabra inglesa **steward** no tiene nada que ver con la aviación: es él quien está en la pista de calentamiento; si observa un problema, interviene y avisa al jurado, que decide.",
          it:"Sorveglia il campo prova, controlla le imboccature e fa rispettare la sicurezza. ⚠️ La parola inglese **steward** non c'entra con l'aviazione: è lui che trovi al campo prova; se nota un problema, interviene e informa la giuria, che decide.",
          de:"Überwacht das Abreiten, prüft die Gebisse, sorgt für Sicherheit. ⚠️ **Steward** hat nichts mit Luftfahrt zu tun: Er steht am Abreiteplatz — bei Verstößen greift er ein und meldet sie der Jury, die entscheidet.",
          ja:"練習馬場を見張り、ハミを検査し、安全を守らせる係。⚠️ 英語の **steward** は飛行機とは無関係。練習馬場にいるのがこの人で、問題があれば介入し、審判団に伝えて判断を仰ぎます。",
  ...
  { ref:"frais-engagement", lecon:1, coll:"engager",
    mots:{ fr:{m:"les frais d'engagement"}, en:{m:"the entry fee", p:"èn-tri fii"},
           ...
           ar:{m:"رسوم التسجيل"} },
    def:{ fr:"⚠️ Ils se paient à l'engagement, pas à l'arrivée. Leur remboursement en cas de forfait dépend du règlement, de la date et des justificatifs demandés — après la clôture, tout ou partie peut rester dû. L'allemand dit *Nenngeld*, « l'argent de la nomination ».",
          en:"Paid when you enter, not on arrival. Whether they are refunded after a withdrawal depends on the rules, the date and the paperwork required.",
          es:"Se pagan al inscribirse, no al llegar. Su devolución en caso de retirada depende del reglamento, de la fecha y de los justificantes exigidos.",
          it:"Si pagano all'iscrizione, non all'arrivo. Il rimborso in caso di ritiro dipende dal regolamento, dalla data e dai giustificativi richiesti.",
          de:"Wird bei der Nennung fällig, nicht bei der Ankunft. Ob es bei einer Abmeldung erstattet wird, hängt von Reglement, Datum und verlangten Nachweisen ab.",
          ja:"申し込み時に支払い、到着時ではありません。返金されるかどうかは、規則と時期、求められる書類によって決まります。",
  ...
  { ref:"engagement-tardif", lecon:1, coll:"engager",
    ...
    def:{ fr:"Engagement accepté après la clôture, contre un supplément. ⚠️ Il n'est pas automatique : il dépend du règlement, de l'accord de l'organisateur et des places restantes — sur un grand concours, il y en a rarement.",
          en:"An entry taken after the deadline, for a supplement. It isn't automatic: it depends on the rules, the organiser's agreement and remaining places — at a big show there are rarely any.",
          es:"Inscripción aceptada tras el cierre, con recargo. No es automática: depende del reglamento, del acuerdo del organizador y de las plazas que queden.",
          it:"Iscrizione accettata dopo la chiusura, con supplemento. Non è automatica: dipende dal regolamento, dall'accordo dell'organizzatore e dai posti rimasti.",
          de:"Nennung nach dem Nennungsschluss, gegen Aufpreis. Nicht automatisch: sie hängt vom Reglement, der Zustimmung des Veranstalters und freien Plätzen ab.",
          ja:"締切後に受け付けられる申込で、追加料金がかかります。自動ではなく、規則と主催者の承認、残席次第です。大きな大会では空きはほとんどありません。",
  ...
  { ref:"numero-tetiere", lecon:1, coll:"engager",
    ...
    def:{ fr:"🟥 EN ANGLAIS C'EST **THE BRIDLE NUMBER**, jamais « the head number ». Un numéro d'identification fixé sur le filet, à l'endroit prévu par le règlement — certains concours en demandent un de chaque côté. C'est le cheval qui est identifié, pas le cavalier. ⚠️ Les règles varient selon l'épreuve : vérifie le numéro et son emplacement au bureau AVANT de préparer le cheval.",
          en:"« The bridle number », never « the head number ». An identification number fixed to the bridle where the rules require — some shows ask for one on each side. It identifies the horse, not the rider. Rules vary by event: check the number and its place at the office before tacking up.",
          es:"En inglés « bridle number ». Un número de identificación fijado a la cabezada donde indique el reglamento — algunos concursos piden uno a cada lado. Identifica al caballo, no al jinete.",
          it:"In inglese « bridle number ». Un numero di identificazione fissato alla testiera dove previsto dal regolamento — alcuni concorsi ne chiedono uno per lato. Identifica il cavallo, non il cavaliere.",
          de:"Englisch « bridle number ». Eine Kennnummer am Zaum, dort, wo es das Reglement vorsieht — manche Turniere verlangen eine je Seite. Sie kennzeichnet das Pferd, nicht den Reiter.",
          ja:"英語では bridle number と言います。規則が定める位置に頭絡へつける識別番号で、両側に一つずつ求める大会もあります。識別されるのは騎手ではなく馬です。規則は大会ごとに異なるので、番号と付ける位置を事務局で確かめてから馬を準備します。",
  ...
  { ref:"changer-epreuve", lecon:1, coll:"engager", v:true,
    ...
    def:{ fr:"⚠️ L'ANGLAIS DIT **TO MOVE**, pas « to change » : *I'd like to move him to the 1.35*. Possible jusqu'à l'heure limite fixée par l'organisateur, selon les places et le règlement — monter ou descendre de hauteur peut obéir à des conditions différentes.",
          en:"English says « to move », not « to change »: I'd like to move him to the 1.35. Possible up to the organiser's deadline, depending on places and rules — moving up or down may come with different conditions.",
          ...
          ja:"英語では change ではなく move を使います。主催者が定める期限内なら、空きと規則に応じて変更できます。上げる場合と下げる場合で条件が異なることがあります。",
  ...
  { ref:"engagement-confirme", lecon:1, coll:"engager",
    mots:{ fr:{m:"l'engagement confirmé"}, en:{m:"the entry confirmed", p:"keune-feurmd"},
           ...
           ar:{m:"تأكيد التسجيل"} },
    def:{ fr:"🟥 LA QUESTION QUI SAUVE UN WEEK-END : « mon engagement a-t-il bien été enregistré ? ». Un engagement payé n'est pas toujours un engagement enregistré — un formulaire perdu, un virement non rapproché, et le nom n'est pas sur la liste. ⚠️ On vérifie assez tôt, au bureau ou dans le système en ligne — pas le matin de l'épreuve.",
          en:"The question that saves a weekend: « Has my entry been confirmed? ». A paid entry isn't always a recorded entry — a lost form, an unmatched transfer, and your name isn't on the list. Check in good time, at the office or online — not on the morning of the class.",
          ...
          ja:"週末を救う質問：「申し込みは登録されていますか」。支払い済みでも登録されていないことがあります。書類の紛失、振込の未照合。確認は余裕をもって、事務局かオンラインで。当日の朝では遅いのです。",
  ...
  { ref:"licence", lecon:1, coll:"engager",
    mots:{ fr:{m:"la licence"}, en:{m:"the membership", p:"mèm-beur-chip", var:"the licence"},
           ...
           ar:{m:"رخصة الفروسية"} }, // ??
    def:{ fr:"⚠️ Le point qui bloque le plus souvent un cavalier à l'étranger : l'anglais parle de **membership**, l'adhésion à la fédération, pas de « licence ». En Grande-Bretagne, les exigences des concours affiliés varient selon la discipline et le niveau : adhésion du cavalier, enregistrement du cheval, ou tickets à la journée selon les cas.",
          en:"The thing that most often blocks a visiting rider: English says membership, not licence. What affiliated shows require varies with the discipline and level: rider membership, horse registration, or day tickets in some cases.",
          es:"⚠️ El punto que más a menudo bloquea a un jinete en el extranjero: el inglés habla de **membership**, la afiliación a la federación, no de « licence ». En Gran Bretaña, las exigencias de los concursos afiliados varían según la disciplina y el nivel: afiliación del jinete, registro del caballo o tickets de día según el caso.",
          it:"⚠️ Il punto che più spesso blocca un cavaliere all'estero: l'inglese parla di **membership**, l'adesione alla federazione, non di « licence ». In Gran Bretagna, le esigenze dei concorsi affiliati variano secondo la disciplina e il livello: adesione del cavaliere, registrazione del cavallo o day ticket secondo i casi.",
          de:"⚠️ Der Punkt, der Reiter im Ausland am häufigsten stoppt: Das Englische spricht von **membership**, der Verbandsmitgliedschaft — nicht von « licence ». In Großbritannien hängen die Anforderungen affiliierter Turniere von Disziplin und Klasse ab: Mitgliedschaft des Reiters, Registrierung des Pferdes oder Tagestickets, je nach Fall.",
          ja:"⚠️ 海外で騎手がいちばん引っかかる点。英語で言うのは **membership** — 連盟への加入のことで、« licence » ではありません。イギリスの公認競技会の条件は、種目とレベルによって異なります。騎手の会員登録、馬の登録、あるいは一日券で足りる場合もあります。",
  ...
  dialogue: {
    ...
    phrases: [
      ...
      { ref:"do-chrono-ou-bareme", temps:2, dit:"joueuse", mots:["epreuve"], motsAilleurs:["chrono","bareme"],
        fr:"Est-ce une épreuve au chronomètre ? Quel barème s'applique ?",
        en:"Is this class against the clock? Which scoring applies?",
        es:"¿Es una prueba al cronómetro? ¿Qué baremo se aplica?",
        it:"È una prova a tempo? Quale barema si applica?",
        de:"Zählt in dieser Prüfung die Zeit? Welche Wertung gilt?",
        ja:"タイム を 計る 競技 です か ? どの 減点 方式 が 適用 され ます か ?",
