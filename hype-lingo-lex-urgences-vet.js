...
window.HYPE_LINGO_LEX["urgences-vet"] = {
  ...
  { ref:"coup-chaleur", lecon:1, coll:"maladie",
    ...
    def:{ fr:"Cinq langues sur six construisent l'image de la même façon : un « coup » ou un « coude » de chaleur. Le cheval souffle, il est abattu, sa peau reste chaude au repos. ⚠️ On l'arrose aux membres et à l'encolure, jamais brutalement sur la croupe : le choc thermique resserre les vaisseaux et garde la chaleur dedans.",
  ...
  { ref:"respire-fort", lecon:1, coll:"signe",
    ...
    def:{ fr:"Le premier signe qu'on entend avant de le voir. ⚠️ Au repos, un cheval respire douze à seize fois par minute — on peut les compter en regardant les flancs. Au-delà de vingt au repos, il y a quelque chose.",
  ...
  { ref:"marcher-cheval", lecon:1, coll:"geste",
    ...
    def:{ fr:"🟥 LE GESTE DE LA COLIQUE, et sa raison : un cheval qui se roule peut se retourner l'intestin, ce qui transforme une colique traitable en urgence chirurgicale. ⚠️ **UNIQUEMENT POUR LA COLIQUE.** Un coup de sang, on l'immobilise — voir `immobiliser`. Se tromper aggrave.",
  ...
  { ref:"points-de-suture", lecon:1, coll:"geste",
    ...
    def:{ fr:"⚠️ L'anglais courant dit **stitches** ; *sutures* est le mot du chirurgien. Une plaie ne se recoud utilement que dans les six à huit heures : au-delà, la contamination est telle qu'on la laisse ouverte. C'est pourquoi l'heure de la blessure est la première question du vétérinaire.",
  ...
  dialogue: {
    ...
    phrases: [
      ...
      { ref:"dk-r-pansement-garrot", temps:4, dit:"club", mots:["bandage","garrot-lien"],
        fr:"Vous savez faire un pansement, ou un garrot si besoin ?",
