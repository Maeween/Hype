...
window.HYPE_LINGO_LEX.pansage = {
  ...
  { ref:"pansage", lecon:1, coll:"outils",
    ...
    def:{ fr:"L'ensemble des soins du poil, des pieds et des crins, avant et après le travail. En anglais, « grooming » désigne à la fois le geste et le métier.",
          ...
          ar:"مجموع العناية بالشعر والحوافر والعرف، قبل العمل وبعده." } },
  ...
  { ref:"boite-pansage", lecon:1, coll:"outils",
    ...
    def:{ fr:"Le coffret où l'on range brosses, étrille et cure-pied. Idéalement une par cheval : c'est ce qui évite de transporter une infection d'un box à l'autre.",
          ...
          ar:"الصندوق الذي تحفظ فيه الفراشي ومكشطة التنظيف ومنقاش الحافر. ويفضل تخصيص صندوق لكل حصان للحد من انتقال العدوى من حصان إلى آخر." } },
  ...
  { ref:"etrille", lecon:1, coll:"outils",
    mots:{ fr:{m:"l'étrille"}, en:{m:"the curry comb", p:"keu-ri kôme", var:"rubber curry (GB)"},
           ...
           ar:{m:"مكشطة تنظيف مطاطية (الإتريل)"} }, // ??
    def:{ fr:"Elle décolle la boue sèche et la poussière, en petits cercles. Jamais sur les membres ni sur la tête : l'os est trop près de la peau.",
          ...
          ar:"أداة مطاطية أو بلاستيكية تفكك الطين الجاف والغبار والشعر الميت بحركات دائرية صغيرة. لا تستخدم على الرأس أو مباشرة فوق المناطق العظمية الحساسة." } },
  ...
  { ref:"brosse-dure", lecon:1, coll:"outils",
    ...
    def:{ fr:"Elle chasse ce que l'étrille a décollé. « Dandy » n'a rien à voir avec l'élégance : c'est simplement le nom anglais de la brosse à poils raides.",
          ...
          ar:"تزيل الغبار والطين والشعر الذي فككته مكشطة التنظيف." } },
  ...
  { ref:"brosse-douce", lecon:1, coll:"outils",
    ...
    def:{ fr:"Elle lustre le poil et se passe partout, tête comprise. ⚠️ L'allemand a deux mots bien séparés : Wurzelbürste pour la dure, Kardätsche pour celle-ci. Les confondre s'entend tout de suite dans une écurie allemande.",
          ...
          ar:"تلمع شعر الحصان، وتستخدم بلطف على الجسم والرأس. والألمانية تفرق بينها وبين الخشنة بكلمتين مستقلتين." } },
  ...
  { ref:"cure-pied", lecon:1, coll:"outils",
    ...
    def:{ fr:"Le premier outil qu'on sort de la boîte. Les quatre pieds, avant et après chaque séance, du talon vers la pointe.",
          ...
          ar:"أول أداة تخرج من الصندوق. تنظف الحوافر الأربعة قبل كل حصة وبعدها، من كعب الحافر نحو مقدمته، مع تجنب الضغط على الأجزاء الحساسة." } },
  ...
  { ref:"eponge", lecon:1, coll:"outils",
    ...
    def:{ fr:"Une éponge pour les yeux et les naseaux, une autre pour l'arrière-main. On ne les échange jamais, et on ne les confond pas.",
          ...
          ar:"إسفنجة للعينين والمنخرين، وأخرى للمنطقة الخلفية. لا تستعملي إحداهما مكان الأخرى ولا تخلطي بينهما." } },
  ...
  { ref:"peigne", lecon:1, coll:"outils",
    ...
    def:{ fr:"Peigne de métal ou de plastique, réservé à la crinière. La queue se démêle aux doigts : le peigne y casse les crins, qui mettent des années à repousser.",
          ...
          ar:"مشط من معدن أو بلاستيك، مخصص للعرف. أما الذيل فيفك تشابكه بالأصابع، لأن المشط قد يكسر شعره الذي يحتاج وقتا طويلا لينمو من جديد." } },
...
/* 🟥 19/08 : REMIS PAR BLANDINE. Il fait paire avec `couteau-chaleur`,
  ...
  { ref:"brosse-eau", lecon:1, coll:"outils",
    ...
    def:{ fr:"Mouillée, elle couche la crinière et lave la paroi du sabot avant le graissage.",
          ...
          ar:"تستخدم وهي مبللة لتسوية العرف وتنظيف جدار الحافر قبل وضع الدهان." } },
  ...
  { ref:"couteau-chaleur", lecon:1, coll:"outils",
    mots:{ fr:{m:"le couteau de chaleur"}, en:{m:"the sweat scraper", p:"souètt skré-peur"},
           ...
           ar:{m:"مكشطة العرق"} }, // ??
    def:{ fr:"La lame souple qui retire l'excès d'eau ou de sueur. Par temps frais, elle aide le cheval à sécher plus vite. Quand il fait chaud, on peut au contraire poursuivre le refroidissement à l'eau sans racler entre chaque application.",
          en:"The flexible blade that removes excess water or sweat. In cool weather it helps the horse dry faster. When it is hot, you can instead keep applying cold water without scraping between applications.",
          es:"La lámina flexible que retira el exceso de agua o sudor. Con tiempo fresco ayuda al caballo a secarse antes. Cuando hace calor, se puede en cambio seguir refrescándolo con agua sin rasear entre aplicaciones.",
          it:"La lama flessibile che toglie l'acqua o il sudore in eccesso. Col tempo fresco aiuta il cavallo ad asciugarsi prima. Quando fa caldo si può invece continuare a rinfrescarlo con l'acqua senza raschiare tra un'applicazione e l'altra.",
          de:"Die biegsame Klinge, die überschüssiges Wasser oder Schweiß abzieht. Bei kühlem Wetter hilft sie dem Pferd, schneller zu trocknen. Bei Hitze kann man dagegen weiter kaltes Wasser aufbringen, ohne dazwischen abzuziehen.",
          ja:"余分な水や汗を取り除く、しなやかな板。涼しいときは馬が早く乾くのを助けます。暑いときは逆に、こそげ取らずに冷水をかけ続けてかまいません。",
          ar:"أداة ذات حافة مرنة تزيل فائض الماء أو العرق. في الطقس البارد تساعد الحصان على الجفاف بسرعة أكبر، أما في الحر فيمكن مواصلة تبريده بالماء من دون كشط الماء بين كل مرة وأخرى." } },
  ...
  { ref:"graisse-pieds", lecon:1, coll:"outils",
    mots:{ fr:{m:"la graisse à pieds", var:"l'onguent"}, en:{m:"hoof oil", p:"houf oïl", var:"hoof grease"},
           ...
           ar:{m:"دهان الحوافر"} },
    def:{ fr:"S'applique sur un sabot propre, selon le produit et les besoins du cheval. Un emploi excessif ou inadapté peut modifier l'équilibre d'humidité de la corne : demande conseil au maréchal-ferrant.",
          en:"Applied to a clean hoof, according to the product and the horse's needs. Overuse or the wrong product can upset the moisture balance of the horn — ask your farrier.",
          es:"Se aplica sobre un casco limpio, según el producto y las necesidades del caballo. Un uso excesivo o inadecuado puede alterar el equilibrio de humedad del casco: consulta al herrador.",
          it:"Si applica su uno zoccolo pulito, secondo il prodotto e le esigenze del cavallo. Un uso eccessivo o inadatto può alterare l'equilibrio di umidità del corno: chiedi consiglio al maniscalco.",
          de:"Wird auf den sauberen Huf aufgetragen, je nach Produkt und Bedarf des Pferdes. Übermäßiger oder falscher Gebrauch kann das Feuchtigkeitsgleichgewicht des Horns stören — frag deinen Hufschmied.",
          ja:"きれいな蹄に、製品と馬の状態に応じて塗ります。使いすぎや合わない製品は、蹄壁の水分バランスを崩すことがあります。装蹄師に相談してください。",
          ar:"يوضع على حافر نظيف وفقا لنوع المنتج وحاجة الحصان. وقد يؤثر الاستخدام المفرط أو غير المناسب في توازن رطوبة قرن الحافر، لذلك استشيري البيطار." } },
  ...
  { ref:"poil", lecon:2, coll:"corps",
    ...
    def:{ fr:"Le pelage. Son brillant est le premier signe visible de la santé d'un cheval — et il vient d'abord du dedans.",
          ...
          ar:"الشعر الذي يغطي جسم الحصان. ويعد لمعانه أحد العلامات الظاهرة على صحته، لكنه يتأثر أيضا بالتغذية والموسم والعناية." } },
  ...
  { ref:"criniere", lecon:2, coll:"corps",
    ...
    def:{ fr:"Les crins de l'encolure. Dans la tradition classique, on les couche du côté droit.",
          ...
          ar:"شعر العنق. وفي التقليد الكلاسيكي، يسرح عادة إلى الجهة اليمنى." } },
...
/* 🟥 19/08 : REMIS PAR BLANDINE. Le quatrième crin brossé, avec `poil`,
  ...
  { ref:"toupet", lecon:2, coll:"corps",
    ...
    def:{ fr:"La mèche qui tombe entre les oreilles. On la ramène par-dessus le frontal quand on met le filet.",
          ...
          ar:"الخصلة التي تتدلى بين الأذنين. وعند وضع اللجام تسحب برفق فوق شريط الجبهة." } },
  ...
  { ref:"queue", lecon:2, coll:"corps",
    ...
    def:{ fr:"⚠️ L'allemand a un mot propre au cheval : der Schweif. Schwanz, le mot courant pour la queue d'un animal, ne s'emploie pas en écurie.",
          ...
          ar:"الشعر الطويل الذي يغطي ذنب الحصان. وللألمانية كلمة خاصة بالحصان لا تستعمل للحيوانات الأخرى في الإسطبل." } },
  ...
  { ref:"membres", lecon:2, coll:"corps",
    ...
    def:{ fr:"On les brosse doucement, à la brosse douce et jamais à l'étrille : l'os est juste sous la peau.",
          ...
          ar:"تنظف القوائم برفق بالفرشاة الناعمة، ولا تستخدم عليها مكشطة قاسية، لأن العظم قريب من الجلد." } },
  ...
  { ref:"dos", lecon:2, coll:"corps",
    ...
    def:{ fr:"La zone à vérifier avant de seller : un grain de sable resté sous le tapis suffit à blesser en une reprise.",
          ...
          ar:"المنطقة التي تفحص قبل وضع السرج، فحبة رمل واحدة عالقة تحت لبدة السرج قد تسبب جرحا خلال حصة واحدة." } },
  ...
  { ref:"encolure", lecon:2, coll:"corps",
    ...
    def:{ fr:"Du garrot à la tête. C'est par là qu'on commence le pansage, jamais par l'arrière-main.",
          ...
          ar:"يمتد من الغارب إلى الرأس. ابدئي العناية من العنق أو الكتف حتى يرى الحصان اقترابك، ولا تفاجئيه من الخلف." } },
  ...
  { ref:"panser", lecon:3, coll:"gestes", v:true,
    ...
    def:{ fr:"Le verbe d'ensemble. ⚠️ En français il veut aussi dire soigner une plaie ; l'anglais sépare les deux (« to dress a wound »).",
          ...
          ar:"الفعل الجامع. وفي الفرنسية يعني أيضا معالجة جرح، بينما تفصل الإنجليزية بين المعنيين." } },
  ...
  { ref:"brosser", lecon:3, coll:"gestes", v:true,
    ...
    def:{ fr:"Dans le sens du poil, de l'avant vers l'arrière, en appuyant sur le corps et à peine sur les membres.",
          ...
          ar:"مرري الفرشاة في اتجاه الشعر، من الأمام إلى الخلف. اضغطي باعتدال على الجسم، وبضغط خفيف جدا على القوائم." } },
  ...
  { ref:"etriller", lecon:3, coll:"gestes", v:true,
    ...
    def:{ fr:"Passer l'étrille en petits cercles avant la brosse, pour faire remonter poussière et poils morts.",
          ...
          ar:"تمرير مكشطة التنظيف بحركات دائرية صغيرة قبل الفرشاة لإخراج الغبار والشعر الميت إلى سطح الشعر." } },
  ...
  { ref:"curer-pieds", lecon:3, coll:"gestes", v:true,
    ...
    def:{ fr:"Du talon vers la pointe, jamais l'inverse, pour ne pas blesser la fourchette. C'est le geste qui trouve le caillou, le clou ou l'odeur qui annonce un problème.",
          ...
          ar:"نظفي الحافر من الكعب نحو مقدمته، مع العمل بحذر حول سنبكة الحافر حتى لا تجرحيها. ويسمح ذلك باكتشاف حصاة أو مسمار أو رائحة غير طبيعية قد تشير إلى مشكلة." } },
  ...
  { ref:"demeler", lecon:3, coll:"gestes", v:true,
    ...
    def:{ fr:"On part du bas de la mèche et on remonte, brin par brin. Un crin arraché met deux ans à repousser.",
          ...
          ar:"ابدئي من أسفل الخصلة ثم اصعدي تدريجيا، وافصلي الشعر بأصابعك خصلة بعد خصلة." } },
  ...
  { ref:"tresser", lecon:3, coll:"gestes", v:true,
    ...
    def:{ fr:"⚠️ Double piège : « to plait » se prononce « platt » en Grande-Bretagne, et les Américains disent « to braid ». Deux mots pour le même geste de concours.",
          ...
          ar:"فخ مزدوج في الإنجليزية: كلمتان مختلفتان للحركة نفسها، واحدة بريطانية والأخرى أمريكية." } },
...
/* 🟥 19/08 : REMIS PAR BLANDINE. ⚠️ `tondeuse`, son outil, RESTE EN
  ...
  { ref:"tondre", lecon:3, coll:"gestes", v:true,
    ...
    def:{ fr:"Raser tout ou partie du poil d'hiver pour que le cheval sèche vite. ⚠️ En anglais c'est « to clip » ; « to shear » est réservé aux moutons.",
          ...
          ar:"حلق الشعر الشتوي كله أو بعضه ليجف الحصان بسرعة. وفي الإنجليزية كلمة خاصة بالخيل تختلف عن كلمة جز صوف الغنم." } },
  ...
  { ref:"secher", lecon:3, coll:"gestes", v:true,
    ...
    def:{ fr:"On racle, on frictionne, on marche. L'allemand a un verbe pour sécher un cheval en le montant au pas : trockenreiten.",
          ...
          ar:"يزال فائض الماء، ثم يفرك الحصان ويمشى به حتى يجف. وللألمانية فعل خاص لتجفيف الحصان أثناء ركوبه على مشية الخطو." } },
  ...
  { ref:"graisser", lecon:3, coll:"gestes", v:true,
    ...
    def:{ fr:"Dernier geste du pansage de concours, sur un pied propre et sec, sole comprise.",
          ...
          ar:"آخر خطوة من خطوات العناية قبل المسابقة. يوضع الدهان على حافر نظيف وفقا لتعليمات المنتج وحاجة الحافر." } },
  ...
  { ref:"eponger-yeux", lecon:3, coll:"gestes", v:true,
    ...
    def:{ fr:"À l'eau claire, avec l'éponge réservée à la tête, du coin de l'œil vers l'extérieur. Puis les naseaux.",
          ...
          ar:"امسحي العينين بماء نظيف وبالإسفنجة المخصصة للرأس، من الزاوية الداخلية للعين نحو الخارج، ثم امسحي المنخرين." } },
  ...
  { ref:"boue", lecon:4, coll:"etat",
    mots:{ fr:{m:"la boue"}, en:{m:"the mud", p:"meud"},
           ...
           ar:{m:"الطين"} },
    def:{ fr:"On la laisse sécher avant de l'enlever : brossée mouillée, elle s'incruste dans le poil. Sauf là où passeront la selle, la sangle ou les protections — cette boue-là s'enlève tout de suite.",
          ...
          ar:"يفضل ترك الطين يجف قبل إزالته بالفرشاة، إلا إذا كان في موضع ستوضع عليه المعدات أو كان من الضروري تنظيف الجلد وفحصه فورا." } },
  ...
  { ref:"sueur", lecon:4, coll:"etat",
    ...
    def:{ fr:"Séchée sur le poil, elle irrite, surtout sous la selle et la sangle. À racler ou rincer après chaque séance.",
          ...
          ar:"قد يسبب العرق الجاف تهيج الجلد، وخصوصا تحت السرج والحزام. لذلك يجب شطفه أو إزالته بعد العمل." } },
  ...
  { ref:"noeud", lecon:4, coll:"etat",
    ...
    def:{ fr:"Dans la crinière ou la queue. L'allemand a un mot pour le stade suivant, quand les crins sont feutrés : der Filz.",
          ...
          ar:"في العرف أو في الذيل. وللألمانية كلمة للمرحلة التالية، حين يتلبد الشعر." } },
  ...
  { ref:"propre", lecon:4, coll:"etat",
    ...
    def:{ fr:"Le mot qu'on entend quand le pansage est validé. En japonais, きれい veut dire à la fois propre et beau.",
          ...
          ar:"الكلمة التي تسمعينها عندما تعتمد نظافة الحصان. وفي اليابانية تعني الكلمة نفسها نظيفا وجميلا في الوقت نفسه." } },
  ...
  { ref:"sale", lecon:4, coll:"etat",
    ...
    def:{ fr:"À entendre sans se vexer : dans une écurie, c'est une consigne, pas un reproche.",
          ...
          ar:"قد تسمعين هذه الكلمة من دون أن تنزعجي، فهي في الإسطبل ملاحظة أو توجيه وليست إهانة." } }
  ],
  ...
  phrases: [
    { ref:"ou-boite", lecon:1,
      ...
      ja:"手入れ用具 は どこ です か ?",
      ar:"أين صندوق أدوات تنظيف الحصان؟" },
    ...
    { ref:"sue-racler", lecon:4,
      ...
      ar:"لقد تعرق، لذلك سأمشي به قليلا." }
  ],
  ...
  ================================================================== */
  dialogue: {
    ville: "lambourn", lecon: 1, temps: 6, langues: ["fr","en","es","it","de","ja","ar"],   /* 20 phrases */
    ...
    phrases: [
      ...
      ar:"هل يمكنك تنظيفه والعناية به قبل الحصة؟" },
      ...
      ar:"هل يمكنني استعارة مكشطة تنظيف؟" },
      ...
      ar:"ابدئي بمكشطة التنظيف، ثم بالفرشاة الخشنة." },
      ...
      ar:"هل أفرشه قبل تنظيف الحوافر أم بعده؟" },
      ...
      ar:"نظفي الحوافر الأربعة دائما قبل وضع السرج." },
      ...
      ar:"ما زال هناك طين حول أسفل قوائمه." },
      ...
      ar:"هل يمكنني فك تشابك ذيله بالمشط؟" },
      ...
      ar:"انتبهي إلى قوائمه، فهو حساس ولا يحب لمسها." },
      ...
      ar:"هل يمكنني مسح عينيه بالإسفنجة؟" },
      ...
      ar:"جففيه جيدا قبل إعادته إلى البوكس." },
