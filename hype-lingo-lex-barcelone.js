...
window.HYPE_LINGO_LEX.barcelone = {
  ...
  { ref:"licol", lecon:1, coll:"materiel",
    mots:{ fr:{m:"le licol"}, en:{m:"the headcollar", p:"hed-ko-leur", var:"the halter (US)"},
           ...
           ar:{m:"الرسن"} },
    def:{ fr:"Harnais de tête sans mors, pour tenir et mener le cheval à la main. Un licol ordinaire ne se laisse pas sur un cheval en liberté : il ne cède pas s'il s'accroche. Il existe des licols de sécurité, conçus pour se rompre.",
          en:"Bitless head harness used to hold and lead a horse. An ordinary headcollar is not left on a loose horse: it will not give way if it catches on something. Breakaway headcollars are made for that.",
          es:"Cabezada sin bocado, para sujetar y llevar al caballo de la mano. Un cabestro corriente no se deja puesto en un caballo suelto: no cede si se engancha. Existen cabestros de seguridad, hechos para romperse.",
          it:"Capezza senza imboccatura, per tenere e condurre il cavallo a mano. Una capezza normale non si lascia a un cavallo libero: non cede se si impiglia. Esistono capezze di sicurezza, fatte per rompersi.",
          de:"Kopfstück ohne Gebiss, zum Halten und Führen an der Hand. Ein gewöhnliches Halfter lässt man einem frei laufenden Pferd nicht an: Es gibt nicht nach, wenn es hängen bleibt. Dafür gibt es Sicherheitshalfter, die reißen.",
          ja:"ハミのない頭絡。馬を引いて歩くためのもの。普通のハルターは放牧中の馬には着けたままにしません。引っかかっても外れないからです。そのために、切れるように作られた安全ハルターがあります。",
  ...
  { ref:"van", lecon:2, coll:"vehicule",
    mots:{ fr:{m:"le van"}, en:{m:"the trailer", p:"tré-leur", var:"horsebox = le camion (GB)"},
           ...
           ar:{m:"المقطورة"} }, // ??
    def:{ fr:"⚠️ Faux ami à double fond : le mot français « van » vient de l'anglais *caravan*, mais l'anglais dit **trailer** pour le van attelé et **horsebox** pour le camion. Un Américain dit le plus souvent *trailer* pour les deux — *horse van* existe, mais reste rare.",
          en:"French « van » comes from caravan, but English says trailer for the towed one and horsebox for the lorry. An American will usually say trailer for both; horse van exists but is rare.",
          es:"⚠️ Falso amigo de doble fondo: la palabra francesa « van » viene del inglés *caravan*, pero el inglés dice **trailer** para el remolque y **horsebox** para el camión. Un americano dice normalmente *trailer* para los dos; *horse van* existe, pero es poco frecuente.",
          it:"⚠️ Falso amico a doppio fondo: la parola francese « van » viene dall'inglese *caravan*, ma l'inglese dice **trailer** per il rimorchio e **horsebox** per il camion. Un americano dice di solito *trailer* per entrambi; *horse van* esiste, ma è raro.",
          de:"⚠️ Falscher Freund mit doppeltem Boden: Das französische « van » kommt vom englischen *caravan* — aber Englisch sagt **trailer** für den Anhänger und **horsebox** für den LKW. Ein Amerikaner sagt meist für beides *trailer*; *horse van* gibt es, ist aber selten.",
          ja:"⚠️ 二重底の偽りの友：フランス語の « van » は英語の *caravan* 由来なのに、当の英語は牽引式を **trailer**、トラック型を **horsebox** と言います。アメリカ人はたいていどちらも *trailer* と言い、*horse van* という語もありますが、まれです。",
  ...
  { ref:"filet-foin", lecon:3, coll:"nourriture",
    mots:{ fr:{m:"le filet à foin"}, en:{m:"the haynet", p:"hé-nett"},
           ...
           ar:{m:"شبكة الدريس"} },
    def:{ fr:"Filet à mailles serrées qui ralentit la prise de foin. À accrocher assez haut pour qu'un pied ne s'y prenne pas, sans obliger le cheval à manger la tête levée.",
          en:"Small-mesh net that slows hay intake. Tie it high enough that a foot cannot get caught, without forcing the horse to eat with its head up.",
          es:"Red de malla estrecha que ralentiza la toma de heno. Se cuelga bastante alto para que un pie no se enganche, sin obligar al caballo a comer con la cabeza levantada.",
          it:"Rete a maglie strette che rallenta l'assunzione del fieno. Da appendere abbastanza in alto perché un piede non vi si impigli, senza costringere il cavallo a mangiare a testa alta.",
          de:"Engmaschiges Netz, das die Heuaufnahme verlangsamt. Hoch genug aufhängen, damit sich kein Huf verfängt — aber nicht so hoch, dass das Pferd mit erhobenem Kopf fressen muss.",
          ja:"目の細かい網で、乾草を食べる速さをゆるめます。蹄が引っかからない高さに吊るし、ただし頭を上げて食べさせるほど高くはしないこと。",
